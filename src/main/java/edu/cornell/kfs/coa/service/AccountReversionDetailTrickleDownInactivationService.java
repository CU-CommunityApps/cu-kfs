 ...
 */
public interface AccountReversionDetailTrickleDownInactivationService {
    /**
     ...
     */
    public abstract void trickleDownInactiveAccountReversionDetails(AccountReversion accountReversion, String documentNumber);
     ...
     */
    public abstract void trickleDownInactiveAccountReversionDetails(ReversionCategory accountReversionCategory, String documentNumber);
     ...
     * @param documentNumber the document id of the organization reversion document causing an inactivation
     */
    public abstract void trickleDownActiveAccountReversionDetails(AccountReversion accountReversion, String documentNumber);
     ...
     * @param documentNumber the document id of the organization reversion category document causing an inactivation
     */
    public abstract void trickleDownActiveAccountReversionDetails(ReversionCategory accountReversionCategory, String documentNumber);
}
