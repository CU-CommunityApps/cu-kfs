...
public class SubAccountGlobal extends GlobalObjectWithIndirectCostRecoveryAccounts implements GlobalBusinessObject {
	...
	@Override
	protected List<IndirectCostRecoveryAccount> buildUpdatedIcrAccountsList(
			GlobalBusinessObjectDetailBase globalDetail,
			List<IndirectCostRecoveryAccount> addList) {
		SubAccountGlobalDetail subAccountGlobalDetail = (SubAccountGlobalDetail)globalDetail;
		List<IndirectCostRecoveryAccount> updatedA21IcrAccounts = new ArrayList<IndirectCostRecoveryAccount>();
