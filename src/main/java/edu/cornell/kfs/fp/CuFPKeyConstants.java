...
public class CuFPKeyConstants {
    
    public static final String ERROR_CBCP_BATCH_UPLOAD_EMAIL_SUBJECT = "error.cbcp.batch.upload.email.subject";
    public static final String ERROR_CBCP_BATCH_UPLOAD_EMAIL_BODY_STARTER = "error.cbcp.batch.upload.email.body.starter";
    public static final String MESSAGE_CBCP_ROUTE_STEP_REPORT_SUPMMARY_SUBHEADER = "message.cbcp.route.step.report.summary.subheader";
    ...
    public static final String REPORT_CREATE_ACCOUNTING_DOCUMENT_SUMMARY_OVERVIEW_FILE = "report.create.accounting.document.summary.overview.file";
    ...
    public static final String REPORT_CREATE_ACCOUNTING_DOCUMENT_SUMMARY_DOCUMENTS_WITH_WARNINGS = "report.create.accounting.document.summary.documents.with.warning";
