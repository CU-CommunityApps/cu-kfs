 ...
 * 
 */
public class MasterCardTransactionDetailAddendum61FieldUtil extends BusinessObjectStringParserFieldUtils
{
	 ...
	 */
	@Override
	public Class<MasterCardTransactionDetailAddendum61> getBusinessObjectClass()
	{
		return MasterCardTransactionDetailAddendum61.class;
	}

	/**
	 * Returns property names of the MasterCardTransactionDetail class in parsing order (the order
	 * they are in the input flat file) for the addendum type 61 (Non Fuel) records.
	 * 
		...
		return new String[]
			{
                ...
                CuFPPropertyConstants.ITEM_PRODUCT_CODE,
                ...
                CuFPPropertyConstants.ALTERNATE_TAX_ID,
