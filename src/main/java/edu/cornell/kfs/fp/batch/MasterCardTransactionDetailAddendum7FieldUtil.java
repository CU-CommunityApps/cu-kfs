 ...
 *
 */
public class MasterCardTransactionDetailAddendum7FieldUtil extends BusinessObjectStringParserFieldUtils
{
   ...
   */
  @Override
  public Class<MasterCardTransactionDetailAddendum7> getBusinessObjectClass()
  {
    return MasterCardTransactionDetailAddendum7.class;
  }

  /**
   * Returns property names of the MasterCardTransactionDetail class in parsing order (the order
   * they are in the input flat file) for the addendum type 7 records.
   *
    ...
    return new String[]
      {
        ...
        CuFPPropertyConstants.FILLER8,
        CuFPPropertyConstants.MERCHANT_ADDRESS,
        CuFPPropertyConstants.FILLER9,
        CuFPPropertyConstants.CORPORATION_NAME,
        CuFPPropertyConstants.FILLER10
      };
  }
