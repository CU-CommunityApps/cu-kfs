 ...
 * 
 */
public class MasterCardTransactionDetailAddendum11FieldUtil extends BusinessObjectStringParserFieldUtils
{
	 ...
	 */
	@Override
	public Class<MasterCardTransactionDetailAddendum11> getBusinessObjectClass()
	{
		return MasterCardTransactionDetailAddendum11.class;
	}

	/**
	 * Returns property names of the MasterCardTransactionDetail class in parsing order (the order
	 * they are in the input flat file) for the addendum type 11 (Purchasing Card User Amount) records.
	 * 
		...
		return new String[]
			{
				...
				CuFPPropertyConstants.USER_AMOUNT,
