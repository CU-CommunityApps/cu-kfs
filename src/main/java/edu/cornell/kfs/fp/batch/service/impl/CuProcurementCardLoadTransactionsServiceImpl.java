 ...
 */
public class CuProcurementCardLoadTransactionsServiceImpl extends org.kuali.kfs.fp.batch.service.impl.ProcurementCardLoadTransactionsServiceImpl
{
  private static final Logger LOG = Logger.getLogger(CuProcurementCardLoadTransactionsServiceImpl.class);

  protected SequenceAccessorService sequenceAccessorService;

  protected static final String PCARD_TRN_SEQ_NAME = "FP_PRCRMNT_CARD_TRN_MT_SEQ";
