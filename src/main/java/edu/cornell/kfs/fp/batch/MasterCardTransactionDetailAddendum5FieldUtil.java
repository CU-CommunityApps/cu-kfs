 ...
 * 
 */
public class MasterCardTransactionDetailAddendum5FieldUtil extends BusinessObjectStringParserFieldUtils
{
	 ...
	 */
	@Override
	public Class<MasterCardTransactionDetailAddendum5> getBusinessObjectClass()
	{
		return MasterCardTransactionDetailAddendum5.class;
	}

	/**
	 * Returns property names of the MasterCardTransactionDetail class in parsing order (the order
	 * they are in the input flat file) for the addendum type 5 (Generic) records.
	 * 
		...
		return new String[]
			{
                ...
                CuFPPropertyConstants.GENERIC_ADDEDNUM_DATA,
