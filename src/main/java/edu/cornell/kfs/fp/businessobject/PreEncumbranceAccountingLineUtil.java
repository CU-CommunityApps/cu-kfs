...
public class PreEncumbranceAccountingLineUtil {
        ...
        public static TreeMap<Date, KualiDecimal> generateDatesAndAmounts(String autoDisEncumberType, Date startDate, Date endDate, int count, KualiDecimal totalAmount, KualiDecimal partialAmount) {
