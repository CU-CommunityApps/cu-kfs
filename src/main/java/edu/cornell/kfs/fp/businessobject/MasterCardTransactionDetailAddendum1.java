...
import edu.cornell.kfs.fp.batch.MasterCardTransactionDetailAddendum1FieldUtil;

/**
 * Adds the fields needed on the record type 5000 addendum 1 (Purchasing Card) records
 *
 * @see MasterCardTransactionDetail
 */
public class MasterCardTransactionDetailAddendum1 extends MasterCardTransactionDetailAddendumBase
{
	private static final long serialVersionUID = 1L;
	private static Logger LOG = Logger.getLogger(MasterCardTransactionDetailAddendum1.class);
	 ...
	 */
	public MasterCardTransactionDetailAddendum1()
	{
		super();
	...
	public void parseInput(String inputRecord)
	{
        ...
        productCode = getValue(inputRecord, CuFPPropertyConstants.PRODUCT_CODE, CuFPPropertyConstants.ITEM_DESCRIPTION);
        ...
        setExtendedItemAmount(getValue(inputRecord, CuFPPropertyConstants.EXT_ITEM_AMOUNT, CuFPPropertyConstants.DEBIT_CREDIT_IND));
        debitCreditInd = getValue(inputRecord, CuFPPropertyConstants.DEBIT_CREDIT_IND, CuFPPropertyConstants.NET_GROSS_IND);
        ...
        setTaxAmount(getValue(inputRecord, CuFPPropertyConstants.TAX_AMOUNT, CuFPPropertyConstants.DISCOUNT_IND));
        discountIndicator = getValue(inputRecord, CuFPPropertyConstants.DISCOUNT_IND, CuFPPropertyConstants.DISCOUNT_AMOUNT);
        setDiscountAmount(getValue(inputRecord, CuFPPropertyConstants.DISCOUNT_AMOUNT, CuFPPropertyConstants.FILLER3));
	}
    ...
    /**
  	 * Returns the BusinessObjectStringParserFieldUtils for addendum type 1 records.
  	 *
  	 * @return instance of MasterCardTransactionDetailAddendum1FieldUtil
    ...
    protected BusinessObjectStringParserFieldUtils getFieldUtil()
  	{
  		...
  		{
  			mctdFieldUtil = new MasterCardTransactionDetailAddendum1FieldUtil();
  		}
