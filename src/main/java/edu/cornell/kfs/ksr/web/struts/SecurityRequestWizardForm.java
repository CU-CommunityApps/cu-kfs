...
public class SecurityRequestWizardForm extends FinancialSystemTransactionalDocumentFormBase {
    ...
    /**
     * Overriding to allow the process wizard call (since the wizard form is not stored in session)
     * 
     * @see org.kuali.kfs.kns.web.struts.form.KualiForm#shouldMethodToCallParameterBeUsed(java.lang.String, java.lang.String,
