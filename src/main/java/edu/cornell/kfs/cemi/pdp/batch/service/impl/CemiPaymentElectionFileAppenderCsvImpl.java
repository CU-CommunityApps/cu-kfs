...
public class CemiPaymentElectionFileAppenderCsvImpl extends CemiPaymentElectionFileAppenderBase {

    private final String baseFilePath;

    public CemiPaymentElectionFileAppenderCsvImpl(final CemiOutputDefinition outputDefinition,
