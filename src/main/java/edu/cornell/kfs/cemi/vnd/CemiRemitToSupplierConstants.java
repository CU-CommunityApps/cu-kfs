...
public final class CemiRemitToSupplierConstants {
    public static final String REMIT_TO_SUPPLIER_OUTPUT_DEFINITION_FILE_PATH = "classpath:/edu/cornell/kfs/cemi/scm/remitto/batch/CemiRemitToSupplierExtractFileOutputDefinition.xml";
    public static final String REMIT_TO_SUPPLIER_TEMPLATE_FILE_PATH = "classpath:edu/cornell/kfs/cemi/scm/remitto/batch/Remit_To_Supplier.xlsx";
    ...
    public static final class RemitToSupplierExtractSheets {
        public static final String REMIT_TO_SUPPLIER = "Remit_To_Supplier";
    }
