...
public class CemiRemitToSupplierFileAppenderCsvImpl extends CemiRemitToSupplierFileAppenderBase {
    
    private final String baseFilePath;
    
    public CemiRemitToSupplierFileAppenderCsvImpl(final CemiOutputDefinition outputDefinition,
