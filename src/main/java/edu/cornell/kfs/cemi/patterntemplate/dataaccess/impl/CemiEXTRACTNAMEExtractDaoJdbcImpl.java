...
public class CemiEXTRACTNAMEExtractDaoJdbcImpl extends CuSqlQueryPlatformAwareDaoBaseJdbc implements CemiEXTRACTNAMEExtractDao {
    ...
    public void queryAndStoreInScopeBusinessObjectKeysForDataExtract(String inScopeBusinessObjectName) {
        ...
        //        .toQuery();
        //
        //final int numRowsInserted = execu teUpdate(query);
        int numRowsInserted = 0;  //local variable only present to have the pattern template compile and should be completely REMOVED when implementing.
    ...
    // object keys for a particular data extraction run date. Table names for this data would follow the pattern:
    ...
    public void storeSpreadsheetRowItemKeyLegecyObjectKeyExractRunDateMapping(final String spreadsheetKey,
        ...
        //        .append(", ").appendAsParameter(Types.VARCHAR, legacyObjectKey)
        ...
        //            legacyObjectKey, jobRunDateString));
        //}
    }
