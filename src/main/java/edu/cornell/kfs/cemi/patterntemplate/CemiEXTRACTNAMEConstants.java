...
public final class CemiEXTRACTNAMEConstants {
    ...
    //
    public static final String EXTRACTNAME_OUTPUT_DEFINITION_FILE_PATH = "classpath:edu/cornell/kfs/cemi/module/patterntemplate/batch/CemiEXTRACTNAMEExtractFileOutputDefinition.xml";
    
    // Where to find the empty mapping template version of the Excel spreadsheet provided by  
    // Huron to populate. The definition should include botht he filename and the file extension.
    //    Example:
    ...
    //
    public static final String EXTRACTNAME_TEMPLATE_FILE_PATH = "classpath:edu/cornell/kfs/cemi/module/patterntemplate/batch/ACTUAL_EXTRACT_FILE_NAME.xlsx";
    
    // Partial file name without file extension used for the spreadsheet file as it is being populated.
    // This name should be the EXTRACTNAME_EXTRACT_PLAIN_FILENAME with _ITH appended to it.
    //    Example:
    ...
    // Actual file name including file extention for the data extraction 
    // spreadsheet file that will be transmitted to the validation server.
    // This file name with extenstion should exactly match what Huron has 
    ...
    // Pattern constants:
    // These items are purposely being left so they will not compile to force configuration each. 
