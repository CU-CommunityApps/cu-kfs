...
public final class CemiAwardScheduleConstants {
    ...
    // This value SHOULD match what is being substituted for term DATAEXTRACTNAME when this
    ...
    //      RemitToSupplier
    //      Supplier
    public static final String CEMI_DATA_EXTRACT_NAME = ;
    
    public static final String CEMI_IN_SCOPE_BUSINESS_OBJECT_NAME = ;
}
