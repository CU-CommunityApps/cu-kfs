...
public class CemiAwardFileSubmitAwardTabRowBo extends CemiIndexedBusinessObjectBase {
    ...
    private String awardFunction;                 // template field name duplicated as function
    ...
    private String awardLineDataFunction;                     // template field name duplicated as function
    ...
    public String getAwardFunction() {
        return awardFunction;
    }

    public void setAwardFunction(String awardFunction) {
        this.awardFunction = awardFunction;
    }
    ...
    public String getAwardLineDataFunction() {
        return awardLineDataFunction;
    }

    public void setAwardLineDataFunction(String awardLineDataFunction) {
        this.awardLineDataFunction = awardLineDataFunction;
    }
