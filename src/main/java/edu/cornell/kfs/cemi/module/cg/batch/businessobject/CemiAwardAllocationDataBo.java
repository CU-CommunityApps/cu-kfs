...
public class CemiAwardAllocationDataBo extends TransientBusinessObjectBase {

    // Submit Award File Allocation data for every award line
    private String proposalNumberUsedForDataRow;
    private String chartOfAccountsCode;
    private String accountNumber;
    private String awardLineDataRowId;
    private String awardLineDataLineNumber;
    private String specialConditionDataRowId;
    private String budgetDataRowId;
    ...
    public String getAwardLineDataLineNumber() {
        return awardLineDataLineNumber;
    }

    public void setAwardLineDataLineNumber(String awardLineDataLineNumber) {
    ...
    public String getBudgetDataRowId() {
        return budgetDataRowId;
    }

    public void setBudgetDataRowId(String budgetDataRowId) {
