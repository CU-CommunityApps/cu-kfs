...
public class CemiAwardScheduleDataBuilderCsvImpl extends CemiAwardScheduleDataBuilderBase {
    ...
    protected void writeDataToIntermediateStorage(String sheetName, Object rowObject) throws IOException {
        ...
        Validate.validState(sheetDefinition != null, "Unexpected CEMI Award Schedule datasheet: %s", sheetName);
        Validate.validState(csvWriter != null, "Unexpected non-writeable Award Schedule datasheet: %s", sheetName);
