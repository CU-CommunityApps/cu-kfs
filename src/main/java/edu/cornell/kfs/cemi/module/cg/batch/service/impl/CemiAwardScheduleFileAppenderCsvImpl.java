...
public class CemiAwardScheduleFileAppenderCsvImpl extends CemiAwardScheduleFileAppenderBase {

    private final String baseFilePath;

    public CemiAwardScheduleFileAppenderCsvImpl(final CemiOutputDefinition outputDefinition,
