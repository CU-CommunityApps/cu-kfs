 ...
 */
public abstract class CynergyMaintainableXMLConversionServiceImpl implements MaintainableXMLConversionService, InitializingBean {

    private static final Logger LOG = LogManager.getLogger(CynergyMaintainableXMLConversionServiceImpl.class);
    ...
    public String transformMaintainableXML(String xml) {
        ...
        try {
            ...
            CynergyMaintenanceXMLConverter xmlConverter = createXMLConverter();
    ...
    protected CynergyMaintenanceXMLConverter createXMLConverter() {
        return new CynergyMaintenanceXMLConverter(classPropertyRuleMaps, dateRuleMap);
    }
     ...
     * but from the krad-development-tools version of that class.
     */
