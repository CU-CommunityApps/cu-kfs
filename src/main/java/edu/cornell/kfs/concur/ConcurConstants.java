...
public class ConcurConstants {
    ...
    public static class StandardAccountingExtractReport {
        ...
        public static final String SAE_VALIDATION_SUB_REPORT_BYPASSED_NOTE_NOT_SET_IN_CONFIGURATION_FILE = "SAE_VALIDATION_SUB_REPORT_BYPASSED_NOTE_NOT_SET_IN_CONFIGURATION_FILE";
