...
public class ConcurKeyConstants {
    ...
    public static final String CONCUR_REQUEST_EXTRACT_EMPLOYEE_ID_NOT_FOUND_IN_KFS = "validation.error.concur.request.extract.employee.id.not.found";
    ...
    public static final String CONCUR_REQQUEST_EXTRACT_NO_REPORT_EMAIL_SUBJECT = "message.concur.requestExtract.no.report.email.subject";
    public static final String CONCUR_REQQUEST_EXTRACT_NO_REPORT_EMAIL_BODY = "message.concur.requestExtract.no.report.email.body";
}
