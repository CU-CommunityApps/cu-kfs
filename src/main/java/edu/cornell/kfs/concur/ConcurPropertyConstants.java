...
public class ConcurPropertyConstants {
    
    public class ConcurEventNotification{
        public static final String CONCUR_EVENT_NOTIFICATION_ID = "concurEventNotificationId";
