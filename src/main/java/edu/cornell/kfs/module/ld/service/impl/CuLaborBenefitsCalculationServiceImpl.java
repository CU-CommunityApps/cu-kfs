...
public class CuLaborBenefitsCalculationServiceImpl extends LaborBenefitsCalculationServiceImpl {
    ...
    public String getBenefitRateCategoryCode(
            ...
            String accountNumber, final String subAccountNumber) {
        ...
        if (subAccountNumber != null) {
            ...
            if (getParameterService().parameterExists(KfsParameterConstants.FINANCIAL_SYSTEM_ALL.class, "USE_COST_SHARE_SOURCE_ACCOUNT_BENEFIT_RATE_IND")) {
                ...
                final String sysParam2 = getParameterService().getParameterValueAsString(KfsParameterConstants.FINANCIAL_SYSTEM_ALL.class, "USE_COST_SHARE_SOURCE_ACCOUNT_BENEFIT_RATE_IND");
                ...
                if ("Y".equalsIgnoreCase(sysParam2)) {
                    ...
                    final Map<String, Object> subFieldValues = new HashMap<String, Object>();
                    ...
                    //perform the lookup
                    final List<A21SubAccount> subAccountList = (List<A21SubAccount>) getBusinessObjectService().findMatching(A21SubAccount.class, subFieldValues);
                    ...
                    if (subAccountList.size() > 0) {
                        ...
                        setCostSharingSourceAccountChartOfAccountsCode(subAccountList.get(0).getCostShareChartOfAccountCode());
                        setCostSharingSourceSubAccountNumber(subAccountList.get(0).getCostShareSourceSubAccountNumber());
                    }
                    else {
                        LOG.info(
