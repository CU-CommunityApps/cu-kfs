...
public class CuContractsGrantsInvoiceReportServiceImpl extends ContractsGrantsInvoiceReportServiceImpl {
    ...
    protected void populateListByAward(
        ...
        /* CUMod: KFSPTS-33340
         * Removed retrieval and placement list population for data values hard coded in template.
         *      ArPropertyConstants.FederalFormReportFields.RECIPIENT_ORGANIZATION
         *      ArPropertyConstants.FederalFormReportFields.ZWEI
         *      ArPropertyConstants.FederalFormReportFields.STREET1
         *      ArPropertyConstants.FederalFormReportFields.STREET2
         *      ArPropertyConstants.FederalFormReportFields.CITY
         *      ArPropertyConstants.FederalFormReportFields.STATE
         *      ArPropertyConstants.FederalFormReportFields.ZIP
         *      ArPropertyConstants.FederalFormReportFields.COUNTY
         *      ArPropertyConstants.FederalFormReportFields.UEI
         */
        ...
        /* CUMod: KFSPTS-33340
         * Removed retrieval and placement list population for data values hard coded in template.
         *     System parameter lookup of ArParameterConstants.ACCOUNTING_BASISArPropertyConstants.FederalFormReportFields.NAME
