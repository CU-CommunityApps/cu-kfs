...
@XmlType(name = "", propOrder = { "customElementIdentifier", "displayName", "customElementValueListOrAttachmentList" })
...
public class CustomElement {
    ...
    private List<Object> customElementValueListOrAttachmentList;
    ...
    public List<Object> getCustomElementValueListOrAttachmentList() {
        if (customElementValueListOrAttachmentList == null) {
            customElementValueListOrAttachmentList = new ArrayList<Object>();
        }
        return this.customElementValueListOrAttachmentList;
    }
