...
public class SupplierSyncMessage {
    ...
    /*
     * Jaggaer's supplier.dtd generated SupplierResponseMessage,
     * LookupRequestMessage and LookupResponseMessage in addition to
     * SupplierRequestMessage. The jaggaer upload supplier with XML integration only
     * needs SupplierRequestMessage. Therefore the other types will be added yet. If
     * and when those POJOs are needed, they can be generated with XJC using the
     * following command xjc -p edu.cornell.kfs.module.purap.jaggaer.supplier.xml
     * -no-header -dtd supplier.dtd
     */
