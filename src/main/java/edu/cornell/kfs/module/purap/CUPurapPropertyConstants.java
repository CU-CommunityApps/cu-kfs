...
public class CUPurapPropertyConstants extends PurapPropertyConstants {
    ...
    public static final String PREQ_WIRE_TRANSFER = "preqWireTransfer";
    public static final String CM_WIRE_TRANSFER = "cmWireTransfer";
    public static final String PREQ_BANK_ROUTING_NUMBER = "preqBankRoutingNumber";
    public static final String PREQ_BANK_STATE_CODE = "preqBankStateCode";
    public static final String CM_BANK_ROUTING_NUMBER = "cmBankRoutingNumber";
    public static final String CM_BANK_STATE_CODE = "cmBankStateCode";
    public static final String PREQ_FD_CURRENCY_TYPE_CODE = "preqForeignCurrencyTypeCode";
    public static final String PREQ_FD_CURRENCY_TYPE_NAME = "preqForeignCurrencyTypeName";
