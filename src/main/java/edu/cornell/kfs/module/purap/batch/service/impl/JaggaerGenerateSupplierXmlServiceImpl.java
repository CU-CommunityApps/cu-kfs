...
public class JaggaerGenerateSupplierXmlServiceImpl implements JaggaerGenerateSupplierXmlService {
    ...
    protected static final DateTimeFormatter DATE_FORMATTER_FOR_HEADER_DATE = 
            DateTimeFormatter.ofPattern(CUKFSConstants.DATE_FORMAT_yyyy_MM_dd_T_HH_mm_ss_SSS_Z, Locale.US);
    protected static final DateTimeFormatter DATE_FORMATTER_FOR_FILE_NAME = 
            DateTimeFormatter.ofPattern(CUKFSConstants.DATE_FORMAT_yyyyMMdd_HHmmssSSS, Locale.US);
    ...
    private Header buildHeader() {
        ...
        header.setTimestamp(LocalDateTime.now(clock).format(DATE_FORMATTER_FOR_HEADER_DATE));
    ...
    public void generateXMLForSyncMessages(List<SupplierSyncMessage> messages) {
        ...
        for (SupplierSyncMessage message : messages) {
            String outputFileName = jaggaerXmlDirectory + findOutputFileNameStarter()
                    + LocalDateTime.now(clock).format(DATE_FORMATTER_FOR_FILE_NAME)
