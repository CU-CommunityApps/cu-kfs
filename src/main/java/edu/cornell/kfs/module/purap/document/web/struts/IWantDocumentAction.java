...
public class IWantDocumentAction extends FinancialSystemTransactionalDocumentActionBase {
    ...
    public ActionForward insertBONote(ActionMapping mapping, ActionForm form, HttpServletRequest request,
        ...
        if (StringUtils.isBlank(iWantDocumentForm.getIWantDocument().getNoteOptionDropdownSelectedValue())) {
            ...
            note.setNoteText(iWantDocumentForm.getIWantDocument().getNoteOptionDropdownSelectedValue());
        }
        ...
        iWantDocumentForm.getIWantDocument().setNoteOptionDropdownSelectedValue(StringUtils.EMPTY);
    ...
    public ActionForward returnToSSC(ActionMapping mapping, ActionForm form, HttpServletRequest request,
        ...
        ((CuDocumentServiceImpl)getDocumentService()).returnDocumentToPreviousNode(document, kualiDocumentFormBase.getAnnotation(), CUPurapConstants.IWantRouteNodes.NO_OP_NODE);
