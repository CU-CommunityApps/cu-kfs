...
public class CUPurapParameterConstants {
 ...
 // KFSPTS-1705
    ...
    public static final String FUND_GROUPS_RESTRICTING_AUTO_APPROVE = "FUND_GROUPS_RESTRICTING_AUTO_APPROVE";
    public static final String SUB_FUND_GROUPS_RESTRICTING_AUTO_APPROVE = "SUB_FUND_GROUPS_RESTRICTING_AUTO_APPROVE";
}
