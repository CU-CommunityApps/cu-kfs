...
public class CUPurapParameterConstants {
 ...
 // KFSPTS-1705
    ...
    public static final String JAGGAER_DEFAULT_SUPPLIER_ADDDRESS_ACTIVE_VALUE = "JAGGAER_DEFAULT_SUPPLIER_ADDDRESS_ACTIVE_VALUE";
    public static final String JAGGAER_DEFAULT_SUPPLIER_ADDDRESS_NOTE_TEXT = "JAGGAER_DEFAULT_SUPPLIER_ADDDRESS_NOTE_TEXT";
