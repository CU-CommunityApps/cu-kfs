...
public class CUPurapParameterConstants {
 ...
 // KFSPTS-1705
    ...
    public static final String JAGGAER_DEFAULT_SUPPLIER_ACTIVE_VALUE = "JAGGAER_DEFAULT_SUPPLIER_ACTIVE_VALUE";
    public static final String JAGGAER_DEFAULT_SUPPLIER_ADDRDESS_ACTIVE_VALUE = "JAGGAER_DEFAULT_SUPPLIER_ADDRDESS_ACTIVE_VALUE";
    public static final String JAGGAER_DEFAULT_SUPPLIER_ADDRDESS_NOTE_TEXT = "JAGGAER_DEFAULT_SUPPLIER_ADDRDESS_NOTE_TEXT";
    ...
    public static final String JAGGAER_UPLOAD_SUPPLIERS_DTD_DOCTYYPE_TAG = "JAGGAER_UPLOAD_SUPPLIERS_DTD_DOCTYYPE_TAG";
