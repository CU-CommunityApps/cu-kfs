...
public final class IWantAmountUtil {
    ...
    public static String[] calculateTotalsForItemChange(String[] itemQuantities, String[] itemUnitPrices, int itemIndex,
        ...
        return new String[] {itemTotals[0].toString(), itemTotals[1].toString(),
                accountAndDifferenceTotals[0].toString(), accountAndDifferenceTotals[1].toString()};
    }
     ...
     * @throws Exception
     */
    private static KualiDecimal[] findTotalOfOneItemAndAll(String[] itemQuantities, String[] itemUnitPrices, int itemIndex) throws ParseException {
     ...
     */
    private static KualiDecimal[] findAccountsTotalAndDifference(String[] useAmountsOrPercents, String[] accountAmountsOrPercents,
            KualiDecimal itemsTotal) throws ParseException {
        KualiDecimal[] totals = new KualiDecimal[2];
        ...
        for (int i = 0; i < useAmountsOrPercents.length; i++) {
            ...
            if (CUPurapConstants.PERCENT.equalsIgnoreCase(useAmountOrPercent)) {
                ...
                accountLineTotal = accountLineTotal.multiply(itemsTotal).divide(new KualiDecimal(NUM_100));
