...
public class JadgaerAdminB2BAction extends KualiAction {
    ...
    public ActionForward jaggaerAdmin(ActionMapping mapping, ActionForm form, HttpServletRequest request,
            HttpServletResponse response) throws Exception {
        LOG.debug("jaggaerAdmin, calling Jaggaer Admin");
        B2BForm b2bForm = (B2BForm) form;
        String url = getCuB2BShoppingService().getPunchOutUrlForRoleSet(GlobalVariables.getUserSession().getPerson(), JaggaerRoleSet.ADMINISTRATOR);
