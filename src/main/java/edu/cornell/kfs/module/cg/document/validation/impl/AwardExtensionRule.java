...
public class AwardExtensionRule extends AwardRule {
    ...
    protected boolean checkBillingFrequency() {
        ...
        if (!org.apache.commons.lang3.StringUtils.equals(newBillingFrequencyCode, oldBillingFrequencyCode)) {
            if (org.apache.commons.lang3.StringUtils.equals(oldBillingFrequencyCode, CGConstants.MILESTONE_BILLING_SCHEDULE_CODE) &&
            ...
            } else if (org.apache.commons.lang3.StringUtils.equals(oldBillingFrequencyCode, CGConstants.PREDETERMINED_BILLING_SCHEDULE_CODE) &&
    ...
    private String getBillingFrequencyDescription(Award award) {
        if (award == null || award.getBillingFrequency() == null) {
