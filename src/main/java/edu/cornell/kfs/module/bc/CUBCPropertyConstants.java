...
public class CUBCPropertyConstants extends BCPropertyConstants {
    ...
    public static final class BudgetConstructionFundingExportProperties {
        ...
        public static final String FINANCIAL_OBJECT_CODE = "Object_Code";
        public static final String FINANCIAL_SUB_OBJECT_CODE = "Sub_Object_Code";
        ...
        public static final String CSF_FULL_TIME_EMPL_QUANTITY = "CSF_Percent_Distribution";
        ...
        public static final String APPT_REQ_CSF_AMT = "Requested_Leave_Amount";
        public static final String APPT_REQ_CSF_FTE_QUANTITY = "Requested_Percent_Distribution";
        public static final String APPT_REQ_CSF_TIME_PERCENT = "Requested_Percent_Time";
        public static final String APPT_TOTAL_INTENDED_AMT = "Total_Intended_Amount";
        public static final String APPT_TOTAL_INTENDED_FTE_QUANTITY = "Total_Intended_Percent_Distribution";
        public static final String APPT_REQ_AMT = "Requested_Amount";
        public static final String APPT_REQ_TIME_PERCENT = "Requested_Time_Percent";
        public static final String APPT_REQ_FTE_QUANTITY = "Requested_Percent_Distribution";
        public static final String APPT_REQ_PAY_RATE = "Requested_Pay_Rate";
