...
public class BudgetConstructionBudgetedSalaryLineExportDaoJdbc 
    ...
    public Collection<BSLExportData> getBSLExtractByPersonUnivId(String univId) {
        ...
        try {
            ...
            // Get the BSL data from the data base, map it to the object and build a result set of objects to be returned to the user.
	        ...
	        return this.getSimpleJdbcTemplate().query(sqlString, mapper, univId, univId);
        }
