...
public interface PaymentWorksNewVendorConversionService {
	...
	/**
	 * Create a new PaymentWorksVendor based on a VendorDetail object and then set the PaymentWorksVendor document number
	 * attribute to the document number supplied.
	 * @param vendorDetail
