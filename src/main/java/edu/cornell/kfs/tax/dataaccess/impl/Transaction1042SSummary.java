 ...
 */
class Transaction1042SSummary extends TransactionDetailSummary {
    ...
    Transaction1042SSummary(int reportYear, java.sql.Date startDate, java.sql.Date endDate, boolean vendorForeign, Map<String,TaxDataRow> dataRows) {
        super(reportYear, startDate, endDate, vendorForeign, CUTaxConstants.TAX_TYPE_1042S, CUTaxConstants.TAX_1042S_PARM_DETAIL, dataRows);
        ...
        tempOverrides = SpringContext.getBean(TaxProcessingService.class).getTransactionOverrides(CUTaxConstants.TAX_TYPE_1042S, startDate, endDate);
