...
abstract class TaxTableRow {
    ...
    static final class TransactionDetailRow extends TaxTableRow {
        ...
        final TaxTableField incomeClassCode;
        final TaxTableField incomeTaxTreadyExemptIndicator;
        ...
        TransactionDetailRow(String rowId, Map<String,TaxTableField> fields, List<String> tables, Map<String,TaxTableField> aliasedFields,
            ...
            this.incomeTaxTreadyExemptIndicator = getAliasedField(TransactionDetailFieldNames.INCOME_TAX_TREATY_EXEMPT_INDICATOR);
    ...
    static final class DerivedValuesRow extends TaxTableRow {
        ...
        final TaxTableField box1;
        final TaxTableField box2;
        final TaxTableField box3;
        final TaxTableField box4;
        final TaxTableField box5;
        final TaxTableField box6;
        final TaxTableField box7;
        ...
        final TaxTableField box15b;
        final TaxTableField box16;
        final TaxTableField box17;
        final TaxTableField box18;
        ...
        DerivedValuesRow(String rowId, Map<String,TaxTableField> fields, List<String> tables, Map<String,TaxTableField> aliasedFields, Integer insertOffset) {
            ...
            this.box1 = getAliasedField(DerivedFieldNames.BOX1);
            this.box2 = getAliasedField(DerivedFieldNames.BOX2);
            this.box3 = getAliasedField(DerivedFieldNames.BOX3);
            this.box4 = getAliasedField(DerivedFieldNames.BOX4);
            this.box5 = getAliasedField(DerivedFieldNames.BOX5);
            this.box6 = getAliasedField(DerivedFieldNames.BOX6);
            this.box7 = getAliasedField(DerivedFieldNames.BOX7);
            ...
            this.box15b = getAliasedField(DerivedFieldNames.BOX15B);
            this.box16 = getAliasedField(DerivedFieldNames.BOX16);
            this.box17 = getAliasedField(DerivedFieldNames.BOX17);
