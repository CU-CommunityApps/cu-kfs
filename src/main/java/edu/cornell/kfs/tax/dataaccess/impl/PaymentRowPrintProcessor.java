...
abstract class PaymentRowPrintProcessor<T extends TransactionDetailSummary> extends TransactionRowProcessor<T> {
    ...
    String[] getFilePathsForWriters(T summary, java.util.Date processingStartDate) {
        ...
        filePathForPaymentsCsv += buildDateFormatForFileSuffixes().format(processingStartDate);
        filePathForPaymentsCsv += CUTaxConstants.Sprintax.TAX_CSV_FILE_SUFFIX;

        filePaths[0] = filePathForPaymentsCsv;
        return filePaths;
    }
