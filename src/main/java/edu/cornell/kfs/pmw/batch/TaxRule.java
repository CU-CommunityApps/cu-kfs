...
public enum TaxRule {
    INDIVIDUAL_US_SSN(PaymentWorksConstants.PaymentWorksTinType.SSN.getKfsTaxTypeCodeAsString(),
            PaymentWorksConstants.PaymentWorksTaxClassification.INDIVIDUAL_SOLE_PROPRIETOR.legacyTranslationToKfsOwnershipTypeCode, true, true, false), 
    INDIVIDUAL_US_EIN(PaymentWorksConstants.PaymentWorksTinType.FEIN.getKfsTaxTypeCodeAsString(),
            PaymentWorksConstants.PaymentWorksTaxClassification.INDIVIDUAL_SOLE_PROPRIETOR.legacyTranslationToKfsOwnershipTypeCode, true, false, true), 
    ...
    FOREIGN_INDIVIDUAL_US_TAX_PAYER(PaymentWorksConstants.PaymentWorksTinType.SSN.getKfsTaxTypeCodeAsString(), 
            PaymentWorksConstants.PaymentWorksTaxClassification.INDIVIDUAL_SOLE_PROPRIETOR.legacyTranslationToKfsOwnershipTypeCode, false, true, false, 
    ...
    FOREIGN_ENTITY(PaymentWorksConstants.PaymentWorksTinType.FOREIGN_TIN.getKfsTaxTypeCodeAsString(), 
            PaymentWorksConstants.PaymentWorksTaxClassification.C_CORPORATION.legacyTranslationToKfsOwnershipTypeCode, false, false, true, true, false,
