...
public class KfsSupplierDiversityDaoJdbc extends PlatformAwareDaoBaseJdbc implements KfsSupplierDiversityDao {
    ...
    private static final String KFS_SUPPLIER_DIVERSITY_SQL_FOR_LEGACY_FORM = "SELECT DVRST.VNDR_SUPP_DVRST_CD AS KFS_SUPP_DVRST_CD, DVRST.VNDR_SUPP_DVRST_DESC KFS_SUPP_DVRST_DESC, PMW_MAP.PMW_SUPP_DVRST_DESC PMW_SUPP_DVRST_DESC FROM KFS.PUR_SUPP_DVRST_T DVRST, KFS.CU_PMW_SUPP_DVRST_MAP_T PMW_MAP WHERE DVRST.VNDR_SUPP_DVRST_DESC = PMW_MAP.VNDR_SUPP_DVRST_DESC AND DVRST.DOBJ_MAINT_CD_ACTV_IND = 'Y' AND PMW_MAP.PMW_FORM_MODE = 'L' ORDER BY DVRST.VNDR_SUPP_DVRST_DESC";
    private static final String KFS_FEDERAL_SUPPLIER_DIVERSITY_SQL_FOR_FOREIGN_FORM = "SELECT DVRST.VNDR_SUPP_DVRST_CD AS KFS_SUPP_DVRST_CD, DVRST.VNDR_SUPP_DVRST_DESC KFS_SUPP_DVRST_DESC, PMW_MAP.PMW_SUPP_DVRST_DESC PMW_SUPP_DVRST_DESC FROM KFS.PUR_SUPP_DVRST_T DVRST, KFS.CU_PMW_SUPP_DVRST_MAP_T PMW_MAP WHERE DVRST.VNDR_SUPP_DVRST_DESC = PMW_MAP.VNDR_SUPP_DVRST_DESC AND DVRST.DOBJ_MAINT_CD_ACTV_IND = 'Y' AND PMW_MAP.PMW_FORM_MODE = 'F' AND PMW_MAP.FED_STATE_FLAG = 'F' ORDER BY DVRST.VNDR_SUPP_DVRST_DESC";
    private static final String KFS_NEW_YORK_SUPPLIER_DIVERSITY_SQL_FOR_FOREIGN_FORM = "SELECT DVRST.VNDR_SUPP_DVRST_CD AS KFS_SUPP_DVRST_CD, DVRST.VNDR_SUPP_DVRST_DESC KFS_SUPP_DVRST_DESC, PMW_MAP.PMW_SUPP_DVRST_DESC PMW_SUPP_DVRST_DESC FROM KFS.PUR_SUPP_DVRST_T DVRST, KFS.CU_PMW_SUPP_DVRST_MAP_T PMW_MAP WHERE DVRST.VNDR_SUPP_DVRST_DESC = PMW_MAP.VNDR_SUPP_DVRST_DESC AND DVRST.DOBJ_MAINT_CD_ACTV_IND = 'Y' AND PMW_MAP.PMW_FORM_MODE = 'F' AND PMW_MAP.FED_STATE_FLAG = 'N' ORDER BY DVRST.VNDR_SUPP_DVRST_DESC";
