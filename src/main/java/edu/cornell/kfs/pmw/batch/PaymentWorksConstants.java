...
public class PaymentWorksConstants {
    ...
    public static final class KFSVendorMaintenaceDocumentConstants {
        ...
        public static final class KFSPoVendorConstants {
            public static final String PAYMENT_TERMS_CODE = "00N30";
            public static final String VENDOR_SHIPPING_TITLE_CODE = "DE";
            public static final String VENDOR_SHIPPING_PAYMENT_TERMS_CODE = "PA";
        }
    }
