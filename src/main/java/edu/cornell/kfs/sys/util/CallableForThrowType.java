 ...
 * 
 * TODO: This interface is nearly the same as the Functions.FailableCallable interface
 * from commons-lang3 version 3.9 and later. Once we upgrade to commons-lang3 3.9+,
 * remove this interface and replace its usage with Functions.FailableCallable instead.
 */
@FunctionalInterface
