...
public class CUKFSConstants {
    ...
    public static final String DELAYED_ASYNCRONOUS_CALL_GROUP = "Delayed Asynchronous Call";
    public static final String DELAYED_ASYNCRONOUS_CALL_JOB_NAME_PREFIX = "Delayed_Asynchronous_Call ";
