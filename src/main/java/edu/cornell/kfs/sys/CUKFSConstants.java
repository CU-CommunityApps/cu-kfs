...
public class CUKFSConstants {
    ...
    // KFSUPGRADE-779
    // The following eight tab error constants were updated due to the PaymentSourceWireTransfer changes introduced with the 2024-04-19 KualiCo Patch Release.
    public static final String PREQ_WIRETRANSFER_TAB_ERRORS_EXTENSION_FIELDS = "document.wireTransfer.payeeAccountTypeCode,";
    public static final String PREQ_WIRETRANSFER_TAB_ERRORS = "PREQWireTransfersErrors,document.wireTransfer.bankName,document.wireTransfer.bankRoutingNumber,document.wireTransfer.bankCityName,document.wireTransfer.bankStateCode," + "document.wireTransfer.bankCountryCode,document.wireTransfer.attentionLineText,document.wireTransfer.additionalWireText,document.wireTransfer.payeeAccountNumber,document.wireTransfer.currencyTypeName,document.wireTransfer.currencyTypeCode," + "document.wireTransfer.wireTransferFeeWaiverIndicator,document.wireTransfer.payeeAccountName," + PREQ_WIRETRANSFER_TAB_ERRORS_EXTENSION_FIELDS + "document.wireTransfer.automatedClearingHouseProfileNumber";
    
    public static final String CM_WIRETRANSFER_TAB_ERRORS_EXTENSION_FIELDS = "document.wireTransfer.extension.payeeAccountTypeCode,";
    public static final String CM_WIRETRANSFER_TAB_ERRORS = "CMWireTransfersErrors,document.wireTransfer.bankName,document.wireTransfer.bankRoutingNumber,document.wireTransfer.bankCityName,document.wireTransfer.bankStateCode," + "document.wireTransfer.bankCountryCode,document.wireTransfer.attentionLineText,document.wireTransfer.additionalWireText,document.wireTransfer.payeeAccountNumber,document.wireTransfer.currencyTypeName,document.wireTransfer.currencyTypeCode," + "document.wireTransfer.wireTransferFeeWaiverIndicator,document.wireTransfer.payeeAccountName," + CM_WIRETRANSFER_TAB_ERRORS_EXTENSION_FIELDS + "document.wireTransfer.automatedClearingHouseProfileNumber";
    
    public static final String PREQ_FOREIGNDRAFTS_TAB_ERRORS = "PREQForeignDraftErrors,document.wireTransfer.foreignCurrencyTypeCode,document.wireTransfer.foreignCurrencyTypeName";
    public static final String CM_FOREIGNDRAFTS_TAB_ERRORS = "CMForeignDraftErrors,document.wireTransfer.foreignCurrencyTypeCode,document.wireTransfer.foreignCurrencyTypeName";
