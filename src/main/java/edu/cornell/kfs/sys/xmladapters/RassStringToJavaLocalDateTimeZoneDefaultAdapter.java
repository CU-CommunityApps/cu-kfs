...
public class RassStringToJavaLocalDateTimeZoneDefaultAdapter extends XmlAdapter<String, LocalDateTime> {
    ...
    protected static final DateTimeFormatter DATE_TIME_ZONE_DEFAULT_FORMATTER_yyyy_MM_dd_T_HH_mm_ss_SSS =
            DateTimeFormatter.ofPattern(CUKFSConstants.DATE_FORMAT_yyyy_MM_dd_T_HH_mm_ss_SSS).withZone(ZoneOffset.systemDefault()).localizedBy(Locale.US);
    ...
    public String marshal(LocalDateTime localDateTimeValue) {
        return (localDateTimeValue != null) ? localDateTimeValue.format(DATE_TIME_ZONE_DEFAULT_FORMATTER_yyyy_MM_dd_T_HH_mm_ss_SSS) : null;
    }

    public static LocalDateTime parseToLocalDateTime(String dateTimeAsString) {
        return LocalDateTime.parse(dateTimeAsString, DATE_TIME_ZONE_DEFAULT_FORMATTER_yyyy_MM_dd_T_HH_mm_ss_SSS);
    }
