...
import com.rsmart.kuali.kfs.sec.businessobject.AccessSecuritySimulation;
...
public class AccessSecuritySimulationLookupableHelperServiceImpl extends KualiLookupableHelperServiceImpl {
    ...
    public List<Column> getColumns() {
        String searchAttributeName = ((String[]) getParameters().get(SecPropertyConstants.ATRIBUTE_NAME))[0];
...
//            }
    ...
    protected List<String> getInquiryTemplateFields() {
        ...
        lookupFields.add(SecPropertyConstants.ATRIBUTE_NAME);
