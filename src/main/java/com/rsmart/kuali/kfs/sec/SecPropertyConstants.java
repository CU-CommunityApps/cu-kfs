...
public class SecPropertyConstants {
    public static final String ATRIBUTE_ID = "attributeId";
    public static final String ATRIBUTE_NAME = "attributeName";
    public static final String ATRIBUTE_VALUE = "attributeValue";
