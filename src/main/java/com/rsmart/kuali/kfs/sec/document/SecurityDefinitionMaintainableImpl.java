...
import com.rsmart.kuali.kfs.sec.businessobject.SecurityDefinitionDocumentType;
        ...
        if (!newMaintenanceAction) {
            ...
            if (permissions != null) {
                for (KimPermissionInfo permissionInfo : permissions) {
                    ...
                    else if (StringUtils.equals(LaborConstants.LABOR_MODULE_CODE, namespaceCode)) {
