...
import com.rsmart.kuali.kfs.sec.datadictionary.AccessSecurityAttributeRestrictionEntry;
import com.rsmart.kuali.kfs.sec.datadictionary.AccessSecurityBusinessObjectEntry;
import com.rsmart.kuali.kfs.sec.identity.SecKimAttributes;
...
/**
 * @see com.rsmart.kuali.kfs.sec.service.AccessSecurityService
 */
public class AccessSecurityServiceImpl implements AccessSecurityService {
    ...
    /**
     * @see com.rsmart.kuali.kfs.sec.service.AccessSecurityService#applySecurityRestrictionsForGLInquiry(java.util.List, org.kuali.rice.kim.bo.Person)
     */
    ...
    /**
     * @see com.rsmart.kuali.kfs.sec.service.AccessSecurityService#applySecurityRestrictionsForLaborInquiry(java.util.List, org.kuali.rice.kim.bo.Person)
     */
    public void applySecurityRestrictionsForLaborInquiry(List<? extends BusinessObject> results, Person person) {
        AttributeSet additionalPermissionDetails = new AttributeSet();
        additionalPermissionDetails.put(SecKimAttributes.NAMESPACE_CODE, LaborConstants.LABOR_MODULE_CODE);

        applySecurityRestrictions(results, person, SecConstants.SecurityTemplateIds.INQUIRY_FIELD_VALUE, additionalPermissionDetails);
    }

    /**
     * @see com.rsmart.kuali.kfs.sec.service.AccessSecurityService#applySecurityRestrictionsForLookup(java.util.List, org.kuali.rice.kim.bo.Person)
     */
    ...
    /**
     * @see com.rsmart.kuali.kfs.sec.service.AccessSecurityService#applySecurityRestrictions(java.util.List, org.kuali.rice.kim.bo.Person, java.lang.String,
    ...
    /**
     * @see com.rsmart.kuali.kfs.sec.service.AccessSecurityService#checkSecurityRestrictionsForBusinessObject(org.kuali.rice.kns.bo.BusinessObject, org.kuali.rice.kim.bo.Person,
     *      com.rsmart.kuali.kfs.sec.businessobject.AccessSecurityRestrictionInfo)
     */
    ...
    /**
     * @see com.rsmart.kuali.kfs.sec.service.AccessSecurityService#canEditDocument(org.kuali.kfs.sys.document.AccountingDocument, org.kuali.rice.kim.bo.Person)
     */
    ...
    /**
     * @see com.rsmart.kuali.kfs.sec.service.AccessSecurityService#canEditDocumentAccountingLine(org.kuali.kfs.sys.document.AccountingDocument,
     *      org.kuali.kfs.sys.businessobject.AccountingLine, org.kuali.rice.kim.bo.Person, com.rsmart.kuali.kfs.sec.businessobject.AccessSecurityRestrictionInfo)
     */
    ...
    /**
     * @see com.rsmart.kuali.kfs.sec.service.AccessSecurityService#canViewDocument(org.kuali.kfs.sys.document.AccountingDocument, org.kuali.rice.kim.bo.Person,
     *      com.rsmart.kuali.kfs.sec.businessobject.AccessSecurityRestrictionInfo)
     */
    ...
    /**
     * @see com.rsmart.kuali.kfs.sec.service.AccessSecurityService#canViewDocumentAccountingLine(org.kuali.kfs.sys.document.AccountingDocument,
     *      org.kuali.kfs.sys.businessobject.AccountingLine, org.kuali.rice.kim.bo.Person)
     */
    ...
    /**
     * @see com.rsmart.kuali.kfs.sec.service.AccessSecurityService#canViewDocumentNotesAttachments(org.kuali.kfs.sys.document.AccountingDocument, org.kuali.rice.kim.bo.Person)
     */
    ...
    protected boolean checkForEditLineOverrides(AccountingDocument document, AccountingLine line, Person person) {
        ...
        // fiscal officer override
        boolean alwaysAllowFOAccess = parameterService.getIndicatorParameter(SecConstants.ACCESS_SECURITY_NAMESPACE_CODE, SecConstants.ALL_PARAMETER_DETAIL_COMPONENT, SecConstants.SecurityParameterNames.ALWAYS_ALLOW_FISCAL_OFFICER_LINE_ACCESS_IND);
        if (alwaysAllowFOAccess && ObjectUtils.isNotNull(line.getAccount().getAccountFiscalOfficerSystemIdentifier())) {
            if (StringUtils.equals(line.getAccount().getAccountFiscalOfficerSystemIdentifier(), person.getPrincipalId())) {
                return true;
            }
        }
     ...
     * @see com.rsmart.kuali.kfs.sec.service.AccessPermissionEvaluator
     */
