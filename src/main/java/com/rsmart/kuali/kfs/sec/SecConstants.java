 ...
 */
package com.rsmart.kuali.kfs.sec;
...
import com.rsmart.kuali.kfs.sec.businessobject.SecurityAttributeMetadata;
...
public class SecConstants {
    ...
    public final static String ACCESS_SECURITY_NAMESPACE_CODE = "KFS-SEC";
    ...
    public class SecurityTemplateIds {
        public static final String VIEW_DOCUMENT_FIELD_VALUE = "1001";
        public static final String VIEW_ACCOUNTING_LINE_FIELD_VALUE = "1002";
        public static final String VIEW_NOTES_ATTACHMENTS_FIELD_VALUE = "1003";
        public static final String EDIT_DOCUMENT_FIELD_VALUE = "1004";
        public static final String EDIT_ACCOUNTING_LINE_FIELD_VALUE = "1005";
        public static final String LOOKUP_FIELD_VALUE = "1006";
        public static final String INQUIRY_FIELD_VALUE = "1007";
    }

    public class SecurityTypes {
        public static final String DEFAULT_ROLE_TYPE = "1";
        public static final String SECURITY_DEFINITION_ROLE_TYPE = "74";
    }
