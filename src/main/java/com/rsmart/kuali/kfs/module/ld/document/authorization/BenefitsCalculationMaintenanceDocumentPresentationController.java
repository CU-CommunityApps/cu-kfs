 ...
 */
package com.rsmart.kuali.kfs.module.ld.document.authorization;
...
public class BenefitsCalculationMaintenanceDocumentPresentationController extends MaintenanceDocumentPresentationControllerBase implements InquiryPresentationController {
    ...
    public Set<String> getConditionallyHiddenPropertyNames(BusinessObject businessObject) {
        ...
        if(offsetParmValue.equalsIgnoreCase("n")) {
            ...
            fields.add(LdConstants.OBJECT_CODE_OFFSET_PROPERTY_NAME);
        } else {
            fields.remove(LdConstants.ACCOUNT_CODE_OFFSET_PROPERTY_NAME);
            fields.remove(LdConstants.OBJECT_CODE_OFFSET_PROPERTY_NAME);
        }
