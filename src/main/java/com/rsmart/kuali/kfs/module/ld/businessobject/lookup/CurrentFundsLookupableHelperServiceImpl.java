...
public class CurrentFundsLookupableHelperServiceImpl extends AbstractLookupableHelperServiceImpl {
    ...
    private KualiDecimal getOutstandingEncum(AccountStatusCurrentFunds bo) {
        ...
        fieldValues.put(KFSPropertyConstants.FINANCIAL_BALANCE_TYPE_CODE, KFSConstants.BALANCE_TYPE_INTERNAL_ENCUMBRANCE); // Encumbrance
        // Balance
        // Type
        fieldValues.put(KFSPropertyConstants.EMPLID, bo.getEmplid());
        fieldValues.put(KFSPropertyConstants.POSITION_NUMBER, bo.getPositionNumber());      // KUALISUPPORT-189: Add Position Number to criteria
