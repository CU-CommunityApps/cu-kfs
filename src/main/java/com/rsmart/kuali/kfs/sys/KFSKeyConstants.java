 ...
 */
package com.rsmart.kuali.kfs.sys;
...
public class KFSKeyConstants {
    ...
    public static final String ERROR_BATCH_PURCAHSE_ORDER_EXISTENCE = "error.batchPurchaseOrder.existence";
    public static final String ERROR_BATCH_PURCAHSE_ORDER_REQUIRED = "error.batchPurchaseOrder.required";
    public static final String ERROR_BATCH_PURCAHSE_ORDER_INACTIVE = "error.batchPurchaseOrder.inactive";
}
