...
public class DisbursementVoucherPayeeDetail extends PersistableBusinessObjectBase {
    ...
    public boolean isStudent() {
        return SpringContext.getBean(DisbursementVoucherPayeeService.class).isStudent(this);
    }
    ...
    public boolean isAlumni() {
        return SpringContext.getBean(DisbursementVoucherPayeeService.class).isAlumni(this);
    }
