...
public interface DisbursementVoucherExtractService {
	 ...
	 * @deprecated this method is not used in batch any longer (immediate extract of DV's occurs in the DV's own route status change handler) and the code 
	 * seems a bit fishy at this point, so likely, institutions shouldn't be using this
	 */
