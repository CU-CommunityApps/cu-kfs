...
public interface BatchInputFileType extends BatchInputType {
    ...
    /**
     * Indicates if the file type being uploaded requires a corresponding .done file to process the uploaded file.
     * 
     * @return True if the batch load process for the associated file type requires a corresponding .done file be present to load the provided file.
     */
