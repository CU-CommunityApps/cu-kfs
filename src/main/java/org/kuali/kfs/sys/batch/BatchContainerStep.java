...
public class BatchContainerStep extends AbstractStep implements ContainerStepListener {
  private static org.apache.log4j.Logger LOG = org.apache.log4j.Logger.getLogger(BatchContainerStep.class);    
    
    
    private String batchContainerDirectory;        
    private Step batchContainerStopStep;
    
    private BatchContainerDirectory directory;
    
    private StringBuffer containerResults;
    private Map<String, BatchStepFileDescriptor> startedSteps;
    private List<BatchStepFileDescriptor[]> completedSteps;
	 ...
	 */
	private Step getStep(BatchStepFileDescriptor batchStepFile) {
	 ...
	 */
    private boolean isStopBatchContainerTriggered(Step step) {
     ...
     */
	private long getSemaphoreProcessingInterval() {
	 ...
	 */
    private void initContainerResults() {        
     ...
     */
    private void logStepStarted(BatchStepFileDescriptor runFile, String logFileName) {
     ...
     * @param logFileName the name of the log created by the Step's executor
     */
    private void logStepFinished(BatchStepFileDescriptor resultFile, String logFileName) {
     ...
     */
	private void logContainerResultsSummary() {
