    ...
    protected void updateExtensionRecord(Integer newFiscalYear, PersistableBusinessObject currentRecord) {
        ...
        if (extension != null) {
            ...
            extension.setObjectId(new Guid().toString());
             if (extension instanceof YearEndPersistableBusinessObjectExtensionBase) {
            	 ((YearEndPersistableBusinessObjectExtensionBase) extension).setUniversityFiscalYear(newFiscalYear);
             } else {
