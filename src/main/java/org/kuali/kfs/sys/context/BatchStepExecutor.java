...
public class BatchStepExecutor implements Runnable {
    ...
    public void run() {
	    ...
	    String stepRunDateTime = dateTimeService.toDateTimeStringForFilename(dateTimeService.getCurrentTimestamp());
	    batchStepFile.setStartedDate(stepRunDate);
	    batchStepFile.setStringStartedDateTime(stepRunDateTime);
