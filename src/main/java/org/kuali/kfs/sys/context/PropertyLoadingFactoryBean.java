...
public class PropertyLoadingFactoryBean implements FactoryBean {
    ...
    public Object getObject() throws Exception {
        ...
        if (StringUtils.isBlank(System.getProperty(HTTP_URL_PROPERTY_NAME))) {
        	...
        	props.put(KSB_REMOTING_URL_PROPERTY_NAME, props.getProperty(PropertyLoadingFactoryBean.HTTP_URL_PROPERTY_NAME) + "/" +props.getProperty(PropertyLoadingFactoryBean.ENVIRONMENT_KEY) +REMOTING_URL_SUFFIX);
        }
