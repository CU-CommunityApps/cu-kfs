...
public class BatchContainerDirectory {
    ...
    public void writeBatchStepRunFile(BatchStepFileDescriptor batchStepFile, int stepIndex) {
    	...
    	File successFile = new File(getDirectoryPath() + runFile.getNameNoExtension() + BatchStepFileDescriptor.STEP_FILE_EXTENSION_SEPARATOR + BatchStepFileDescriptor.getFileExtensionSuccess(batchStepFile.getStringStartedDateTime()));
    ...
    public void writeBatchStepSuccessfulResultFile(BatchStepFileDescriptor batchStepFile) {
    	BatchStepFileDescriptor successFile = getCopyWithNewExtension(batchStepFile, BatchStepFileDescriptor.getFileExtensionSuccess(batchStepFile.getStringStartedDateTime()));
    ...
    public void writeBatchStepErrorResultFile(BatchStepFileDescriptor batchStepFile) {
    	BatchStepFileDescriptor errorFile = getCopyWithNewExtension(batchStepFile, BatchStepFileDescriptor.getFileExtensionError(batchStepFile.getStringStartedDateTime()));
    ...
    public BatchStepFileDescriptor getResultFile(BatchStepFileDescriptor batchStepFile) {
        ...
        String successFileName = getDirectoryPath() + batchStepFile.getNameNoExtension() +"."+ BatchStepFileDescriptor.getFileExtensionSuccess(batchStepFile.getStringStartedDateTime());
        ...
        String errorFileName = getDirectoryPath() + batchStepFile.getNameNoExtension() +"."+ BatchStepFileDescriptor.getFileExtensionError(batchStepFile.getStringStartedDateTime());
    ...
    public String getExceptionFromFile(BatchStepFileDescriptor errorResultFile) {
        if (errorResultFile.isStepFileAnErrorResultFile(errorResultFile.getStringStartedDateTime())) {
