...
public class BatchStepFileDescriptor {
	...
	private String startedStringDateTime;
     ...
     */
    public boolean isStepFileAnErrorResultFile(String batchStepRunDateTime) {
    	return getName().endsWith(BatchStepFileDescriptor.getFileExtensionError(batchStepRunDateTime));
    }
     ...
     */
    public String getStringStartedDateTime() {
        return startedStringDateTime;
    }

    /**
     * @param startedDate the time the step started
     */
    public void setStringStartedDateTime(String startedDateTime) {
        this.startedStringDateTime = startedDateTime;
    }
    /**
     * @return the time the step started
     */
     ...
     */
    public static String getFileExtensionSuccess(String batchStepRunDateTime) {
    	return BatchStepFileDescriptor.STEP_FILE_SUFFIX_RESULT_SUCCESS + "-" + batchStepRunDateTime;
    }

    /**
     * @return the extension for the ERROR file
     */
    public static String getFileExtensionError(String batchStepRunDateTime) {
    	return BatchStepFileDescriptor.STEP_FILE_SUFFIX_RESULT_ERROR + "-" + batchStepRunDateTime;
    }
}
