 ...
 */
public class ClosedAccountOrganizationReversionDetail implements ReversionCategoryInfo {
     ...
     */
    protected ClosedAccountOrganizationReversionDetail(ReversionCategoryInfo organizationReversionDetail) {
