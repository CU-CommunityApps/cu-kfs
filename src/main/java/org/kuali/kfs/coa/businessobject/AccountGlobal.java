 ...
 *
 */
public class AccountGlobal extends GlobalObjectWithIndirectCostRecoveryAccounts implements GlobalBusinessObject {
	...
	@Override
	protected List<IndirectCostRecoveryAccount> buildUpdatedIcrAccountsList(GlobalBusinessObjectDetailBase globalDetail, List<IndirectCostRecoveryAccount> addList){
		AccountGlobalDetail accountGlobalDetail = (AccountGlobalDetail) globalDetail;
		List<IndirectCostRecoveryAccount> updatedIcrAccounts = new ArrayList<IndirectCostRecoveryAccount>();
		updatedIcrAccounts.addAll(accountGlobalDetail.getAccount().getIndirectCostRecoveryAccounts());
		updatedIcrAccounts.addAll(addList);
		return updatedIcrAccounts;
	}

	@Override
	protected void updateGlobalDetailICRAccountCollection(
