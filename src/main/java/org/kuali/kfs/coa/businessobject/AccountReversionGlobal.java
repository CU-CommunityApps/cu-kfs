...
public class AccountReversionGlobal extends PersistableBusinessObjectBase implements GlobalBusinessObject {
    ...
    public AccountReversionGlobal() {
        super();
        accountReversionGlobalDetails = new TypedArrayList(AccountReversionGlobalDetail.class);
        accountReversionGlobalAccounts = new TypedArrayList(AccountReversionGlobalAccount.class);
    }
    ...
    public List buildListOfDeletionAwareLists() {
        ...
        managedLists.add(getAccountReversionGlobalDetails());
        managedLists.add(getAccountReversionGlobalAccounts());
