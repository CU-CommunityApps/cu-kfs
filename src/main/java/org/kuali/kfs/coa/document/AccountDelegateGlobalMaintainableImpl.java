...
public class AccountDelegateGlobalMaintainableImpl extends FinancialSystemGlobalMaintainable {
    ...
    public String getLockingDocumentId() {
        LOG.info("getLockingDocumentId, Checking for superclass lock");
        String lock = super.getLockingDocumentId();
        if (StringUtils.isNotBlank(lock)) {
            LOG.info("getLockingDocumentId, Got superclass lock");
            return lock;
        } else {
            LOG.info("getLockingDocumentId, Checking for AccountDelegateService lock");
            ...
            LOG.info("getLockingDocumentId, Got AccountDelegateService lock");
            return lock;
        }
    }
    ...
    public List<MaintenanceLock> generateMaintenanceLocks() {
        LOG.info("generateMaintenanceLocks, Start generating locks...");
        ...
        LOG.info("generateMaintenanceLocks, Finished generating {} unique locks", maintenanceLocks.size());
    ...
    protected void refreshAccounts() {
        LOG.info("refreshAccounts, Started call");
        if (ObjectUtils.isNotNull(getBusinessObject())
            ...
            LOG.info("refreshAccounts, Refreshing...");
        ...
        LOG.info("refreshAccounts, Finished call");
    }
}
