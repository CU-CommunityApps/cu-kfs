...
public interface OrganizationReversionDetailTrickleDownInactivationService {
     ...
     */
    public abstract void trickleDownInactiveOrganizationReversionDetails(ReversionCategory organizationReversionCategory, String documentNumber);
     ...
     * @param documentNumber the document id of the organization reversion category document causing an inactivation
     */
    public abstract void trickleDownActiveOrganizationReversionDetails(ReversionCategory organizationReversionCategory, String documentNumber);
}
