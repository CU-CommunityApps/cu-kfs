...
public class OrganizationReversionDetailTrickleDownInactivationServiceImpl implements OrganizationReversionDetailTrickleDownInactivationService {
    ...
    public void trickleDownInactiveOrganizationReversionDetails(OrganizationReversion organizationReversion, String documentNumber) {
        organizationReversion.refreshReferenceObject("organizationReversionDetails");
        trickleDownInactivations(organizationReversion.getOrganizationReversionDetails(), documentNumber);
    }
     ...
     */
    public void trickleDownInactiveOrganizationReversionDetails(ReversionCategory organizationReversionCategory, String documentNumber) {
        Map<String, Object> fieldValues = new HashMap<String, Object>();
        fieldValues.put("organizationReversionCategoryCode", organizationReversionCategory.getReversionCategoryCode());
    ...
    public void trickleDownActiveOrganizationReversionDetails(OrganizationReversion organizationReversion, String documentNumber) {
        organizationReversion.refreshReferenceObject("organizationReversionDetails");
        trickleDownActivations(organizationReversion.getOrganizationReversionDetails(), documentNumber);
    }
     ...
     */
    public void trickleDownActiveOrganizationReversionDetails(ReversionCategory organizationReversionCategory, String documentNumber) {
        Map<String, Object> fieldValues = new HashMap<String, Object>();
        fieldValues.put("organizationReversionCategoryCode", organizationReversionCategory.getReversionCategoryCode());
        Collection orgReversionDetails = businessObjectService.findMatching(OrganizationReversionDetail.class, fieldValues);
