...
public class AccountDelegateServiceImpl implements AccountDelegateService {
    ...
    public void updateDelegationRole(String docIdToIgnore) {
        ...
        final String roleId = roleManagementService.getRoleIdByNamespaceCodeAndName(KFSConstants.CoreModuleNamespaces.KFS,
        ...
        if (StringUtils.isNotBlank(roleId)) {
            ...
            KEWServiceLocator.getActionRequestService().updateActionRequestsForResponsibilityChange(
                    getChangedRoleResponsibilityIds(newRoleResp), docIdToIgnore);
        }
    }
