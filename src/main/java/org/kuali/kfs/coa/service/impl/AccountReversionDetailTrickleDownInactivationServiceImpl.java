...
import org.kuali.kfs.coa.service.AccountReversionDetailTrickleDownInactivationService;
...
public class AccountReversionDetailTrickleDownInactivationServiceImpl implements AccountReversionDetailTrickleDownInactivationService {
    ...
    protected void trickleDownInactivations(List<AccountReversionDetail> accountReversionDetails, String documentNumber) {
        TrickleDownStatus status = new TrickleDownStatus(KFSKeyConstants.ACCOUNT_REVERSION_DETAIL_TRICKLE_DOWN_INACTIVATION, KFSKeyConstants.ACCOUNT_REVERSION_DETAIL_TRICKLE_DOWN_INACTIVATION_ERROR_DURING_PERSISTENCE);
    ...
    protected void trickleDownActivations(List<AccountReversionDetail> accountReversionDetails, String documentNumber) {
        TrickleDownStatus status = new TrickleDownStatus(KFSKeyConstants.ACCOUNT_REVERSION_DETAIL_TRICKLE_DOWN_ACTIVATION, KFSKeyConstants.ACCOUNT_REVERSION_DETAIL_TRICKLE_DOWN_ACTIVATION_ERROR_DURING_PERSISTENCE);
