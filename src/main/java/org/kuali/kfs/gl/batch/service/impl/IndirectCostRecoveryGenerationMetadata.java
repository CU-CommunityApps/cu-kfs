...
public class IndirectCostRecoveryGenerationMetadata {
    ...
    private List<CuIndirectCostRecoveryAccountDistributionMetadata> accountLists = new ArrayList<CuIndirectCostRecoveryAccountDistributionMetadata>();
    ...
    public List<CuIndirectCostRecoveryAccountDistributionMetadata> getAccountLists() {
        return accountLists;
    }
    public void setAccountLists(List<CuIndirectCostRecoveryAccountDistributionMetadata> accountLists) {
