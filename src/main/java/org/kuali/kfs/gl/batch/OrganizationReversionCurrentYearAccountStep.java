...
import org.kuali.kfs.gl.batch.service.ReversionProcessService;
...
public class OrganizationReversionCurrentYearAccountStep extends AbstractWrappedBatchStep {
    ...
    private ReversionProcessService organizationReversionProcessService;
    ...
    protected CustomBatchExecutor getCustomBatchExecutor() {
        return new CustomBatchExecutor() {
            ...
            public boolean execute() {
                ...
                getOrganizationReversionProcessService().reversionCurrentYearAccountProcess(jobParameters, organizationReversionCounts);
     ...
     */
    public void setOrganizationReversionProcessService(ReversionProcessService organizationReversionProcessService) {
     ...
     */
    public ReversionProcessService getOrganizationReversionProcessService() {
