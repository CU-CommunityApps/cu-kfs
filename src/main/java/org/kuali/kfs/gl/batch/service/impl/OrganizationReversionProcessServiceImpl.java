 ...
 */
@Transactional
public class OrganizationReversionProcessServiceImpl implements ReversionProcessService {
     ...
     */
    public void reversionPriorYearAccountProcess(Map jobParameters, Map<String, Integer> organizationReversionCounts) {
        if (LOG.isDebugEnabled()) {
            LOG.debug("organizationReversionProcessEndOfYear() started");
        }
        ReversionProcess orp = SpringContext.getBean(ReversionProcess.class,OrganizationReversionProcessServiceImpl.ORGANIZATION_REVERSION_PRIOR_YEAR_ACCOUNT_PROCESS_BEAN_NAME);

        orp.reversionProcess(jobParameters, organizationReversionCounts);
     ...
     */
    public void reversionCurrentYearAccountProcess(Map jobParameters, Map<String, Integer> organizationReversionCounts) {
        if (LOG.isDebugEnabled()) {
            LOG.debug("organizationReversionProcessEndOfYear() started");
        }
        ReversionProcess orp = SpringContext.getBean(ReversionProcess.class,OrganizationReversionProcessServiceImpl.ORGANIZATION_REVERSION_CURRENT_YEAR_ACCOUNT_PROCESS_BEAN_NAME);
     ...
     * @param counts
     */
    public void writeReports(ReversionProcess organizationReversionProcess, Map jobParameters, Map<String, Integer> counts) {
