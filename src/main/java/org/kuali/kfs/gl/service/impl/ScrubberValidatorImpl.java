 ...
 * ====
 * CU Customization:
 * Overlayed this KFS file to fix a "validateSubObjectCode" method bug, by including a fix from the 01/11/2018 KualiCo patch.
 * This overlay can be removed once we upgrade to KualiCo patch 01/11/2018 or newer.
 * ====
 * 
...
//            UniversityDate universityDate = universityDateDao.getByPrimaryKey(originEntry.getFinancialDocumentReversalDate());
    ...
    private boolean isAssetRecoveryGlobalOrTransfer(OriginEntryInformation originEntry) {
        return originEntry.getFinancialDocumentTypeCode().equals("ARG") || originEntry.getFinancialDocumentTypeCode().equals("AT");
    }
