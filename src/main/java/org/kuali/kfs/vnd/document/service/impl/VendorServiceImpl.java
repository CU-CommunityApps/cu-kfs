...
public class VendorServiceImpl implements VendorService {
    ...
    public boolean isVendorInstitutionEmployee(Integer vendorHeaderGeneratedIdentifier) {
        ...
        if (VendorConstants.TAX_TYPE_SSN.equals(vendorToUse.getVendorHeader().getVendorTaxTypeCode())) {
            ...
            if (StringUtils.isNotBlank(ssnTaxId)) {
                List<Person> personList = SpringContext.getBean(PersonService.class).getPersonByExternalIdentifier(KimConstants.PersonExternalIdentifierTypes.TAX, ssnTaxId);
	...
	public boolean isVendorContractExpired(Document document,
			Integer vendorContractGeneratedIdentifier, VendorDetail vendorDetail) {
		return false;
	}
}
