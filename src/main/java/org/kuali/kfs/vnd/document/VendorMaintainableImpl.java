...
public class VendorMaintainableImpl extends FinancialSystemMaintainable {
    ...
    public void saveBusinessObject() {
        ...
        // KFSPTS-1704 : Populate generateid and detail assigned id in doc content after bo is persisted. 
		try {
			...
			if (vndDetail.getVendorHeaderGeneratedIdentifier() == null 
					|| KNSConstants.MAINTENANCE_NEWWITHEXISTING_ACTION.equals(getMaintenanceAction())) {
