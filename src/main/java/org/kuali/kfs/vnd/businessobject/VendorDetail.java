...
public class VendorDetail extends PersistableBusinessObjectBase implements VendorRoutingComparable {
    ...
    private List<VendorCreditCardMerchant> vendorCreditCardMerchants;
	...
	public List<VendorCreditCardMerchant> getVendorCreditCardMerchants() {
		return vendorCreditCardMerchants;
	}

	public void setVendorCreditCardMerchants(
			List<VendorCreditCardMerchant> vendorCreditCardMerchants) {
