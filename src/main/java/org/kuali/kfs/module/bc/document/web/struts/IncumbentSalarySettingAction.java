...
public class IncumbentSalarySettingAction extends DetailSalarySettingAction {
    ...
    public ActionForward loadExpansionScreen(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        // KFSPTS-1293 - (See also PositionSalarySetting.java - loadExpansionScreen method) This issue is that after selecting a row from the list, any subsequent
        ...
        incumbentSalarySettingForm.setEmplid(request.getParameterValues("emplid")[0]);   // ********
        // END OF WORKAROUND
        MessageMap errorMap;
