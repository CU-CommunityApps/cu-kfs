...
public interface BudgetDocumentService {
    ...
    /**
     * Checks a Budget Construction Account Reports entry exists by chart and account number. If it does not exist it attempts to add it to the database.
     * 
     * @param accountNumber
     * @param chartOfAccountsCode
     * @return true if exists or successfully created, false if does not exsits and unable to create
     */
    public boolean buildBudgetConstructionAccountReportsIfNeeded(String accountNumber, String chartOfAccountsCode);
