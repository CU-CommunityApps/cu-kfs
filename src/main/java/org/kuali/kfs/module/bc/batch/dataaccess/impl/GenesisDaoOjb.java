...
public class GenesisDaoOjb extends BudgetConstructionBatchHelperDaoOjb implements GenesisDao {
    ...
    protected void addRIObjectClassesForBB(Integer BaseYear) {
        ...
        for (Map.Entry<String, String[]> problemObjectCodes : gLBBObjects.entrySet()) {
            ...
            Criteria criteriaID = new Criteria();
            criteriaID.addEqualTo(KFSPropertyConstants.UNIVERSITY_FISCAL_YEAR, BaseYear);
            criteriaID.addEqualTo(KFSPropertyConstants.CHART_OF_ACCOUNTS_CODE, problemChart);
            criteriaID.addEqualTo(KFSPropertyConstants.FINANCIAL_OBJECT_CODE, problemObject);
            
            QueryByCriteria queryID = QueryFactory.newQuery(ObjectCode.class, criteriaID);
            ...
            ObjectCode requestYearObject = createCopyObjectCodeForRequestYear(baseYearObject, RequestYear);
            
            getPersistenceBrokerTemplate().store(requestYearObject);
        }
    }
    
    /**
     * Creates a copy of the base year object code for the request year object code.
     * @param baseYearObject
     * @param RequestYear
     * @return a new object code for the request year
     */
    protected ObjectCode createCopyObjectCodeForRequestYear(ObjectCode baseYearObject, Integer RequestYear){
    	
    	  ObjectCode requestYearObject = new ObjectCode();
    	  
          requestYearObject.setChartOfAccountsCode(baseYearObject.getChartOfAccountsCode());
          requestYearObject.setFinancialBudgetAggregationCd(baseYearObject.getFinancialBudgetAggregationCd());
          requestYearObject.setFinancialFederalFundedCode(requestYearObject.getFinancialFederalFundedCode());
          requestYearObject.setFinancialObjectCode(baseYearObject.getFinancialObjectCode());
          requestYearObject.setFinancialObjectCodeName(baseYearObject.getFinancialObjectCodeName());
          requestYearObject.setFinancialObjectCodeShortName(baseYearObject.getFinancialObjectCodeShortName());
          requestYearObject.setFinancialObjectLevelCode(baseYearObject.getFinancialObjectLevelCode());
          requestYearObject.setFinancialObjectSubTypeCode(baseYearObject.getFinancialObjectSubTypeCode());
          requestYearObject.setFinancialObjectTypeCode(baseYearObject.getFinancialObjectTypeCode());
          requestYearObject.setFinObjMandatoryTrnfrelimCd(baseYearObject.getFinObjMandatoryTrnfrelimCd());
          requestYearObject.setHistoricalFinancialObjectCode(baseYearObject.getHistoricalFinancialObjectCode());
          requestYearObject.setName(baseYearObject.getName());
          requestYearObject.setNextYearFinancialObjectCode(baseYearObject.getNextYearFinancialObjectCode());
          requestYearObject.setReportsToChartOfAccountsCode(baseYearObject.getReportsToChartOfAccountsCode());
          requestYearObject.setReportsToFinancialObjectCode(baseYearObject.getReportsToFinancialObjectCode());
  
          requestYearObject.setUniversityFiscalYear(RequestYear);
          requestYearObject.setActive(false);
          
          return requestYearObject;
    }
