...
public class BudgetDocumentServiceImpl implements BudgetDocumentService {
    ...
    protected void calculateAnnualBenefits(BudgetConstructionDocument bcDoc) {
        ...
        if (!bcDoc.isSalarySettingOnly()) {
            ...
            if (sysParam.equalsIgnoreCase("Y")) {
            	 String laborBenefitsRateCategoryCode = ((AccountExtendedAttribute)bcDoc.getAccount().getExtension()).getLaborBenefitRateCategoryCode();
                benefitsCalculationService.calculateAnnualBudgetConstructionGeneralLedgerBenefits(bcDoc.getDocumentNumber(), bcDoc.getUniversityFiscalYear(), bcDoc.getChartOfAccountsCode(), bcDoc.getAccountNumber(), bcDoc.getSubAccountNumber(), laborBenefitsRateCategoryCode);
            } else {
    ...
    protected void calculateMonthlyBenefits(BudgetConstructionDocument bcDoc) {
        ...
        if (!bcDoc.isSalarySettingOnly()) {
            ...
            if (sysParam.equalsIgnoreCase("Y")) {
            	String laborBenefitsRateCategoryCode = ((AccountExtendedAttribute)bcDoc.getAccount().getExtension()).getLaborBenefitRateCategoryCode();
                benefitsCalculationService.calculateMonthlyBudgetConstructionGeneralLedgerBenefits(bcDoc.getDocumentNumber(), bcDoc.getUniversityFiscalYear(), bcDoc.getChartOfAccountsCode(), bcDoc.getAccountNumber(), bcDoc.getSubAccountNumber(),laborBenefitsRateCategoryCode);
            } else {
                // pbgl lines are saved at this point, calc benefits
