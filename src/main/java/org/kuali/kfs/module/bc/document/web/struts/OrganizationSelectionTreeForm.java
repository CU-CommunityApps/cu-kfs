...
public class OrganizationSelectionTreeForm extends BudgetExpansionForm {
    ...
    private boolean hideSipExportButton;
    private boolean hideSipExportExecutivesButton;
	...
	public boolean isHideSipExportButton() {
		return hideSipExportButton;
	}

	public void setHideSipExportButton(boolean value) {
		this.hideSipExportButton = value;
	}

	public boolean isHideSipExportExecutivesButton() {
		return hideSipExportExecutivesButton;
	}

	public void setHideSipExportExecutivesButton(
			boolean hideSipExportExecutivesButton) {
		this.hideSipExportExecutivesButton = hideSipExportExecutivesButton;
	}
