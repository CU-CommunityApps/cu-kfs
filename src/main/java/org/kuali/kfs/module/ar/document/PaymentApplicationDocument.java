...
public class PaymentApplicationDocument extends GeneralLedgerPostingDocumentBase implements GeneralLedgerPendingEntrySource, AmountTotaling {
    ...
    private static final Logger LOG = LogManager.getLogger(PaymentApplicationDocument.class);
    ...
    public boolean isDeletePerformedForInvoicePaidApplied() {
        return deletePerformedForInvoicePaidApplied;
    }

    public void setDeletePerformedForInvoicePaidApplied(boolean deletePerformedForInvoicePaidApplied) {
        this.deletePerformedForInvoicePaidApplied = deletePerformedForInvoicePaidApplied;
    }
