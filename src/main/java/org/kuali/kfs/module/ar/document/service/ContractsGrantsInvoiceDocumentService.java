...
/**
 * FINP-5295 backported onto 2021-01-21 vesion of the file.
 * File will need to be removed when 2021-04-29 patch is applied.
 */
...
public interface ContractsGrantsInvoiceDocumentService {
     ...
     */
    void prorateBill(ContractsGrantsInvoiceDocument contractsGrantsInvoiceDocument) throws WorkflowException;
     ...
     * and this method gets called, it will update the list by adding or removing the suspension categories
     *
     * @param contractsGrantsInvoiceDocument
     */
     ...
     * @throws WorkflowException
     */
    void correctContractsGrantsInvoiceDocument(ContractsGrantsInvoiceDocument document) throws WorkflowException;
