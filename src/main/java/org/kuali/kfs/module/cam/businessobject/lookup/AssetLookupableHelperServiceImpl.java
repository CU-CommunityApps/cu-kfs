...
public class AssetLookupableHelperServiceImpl extends KualiLookupableHelperServiceImpl {
    ...
    protected List<? extends BusinessObject> excludeBlankOffCampusLocations(List<? extends BusinessObject> results) {
    	...
    	int count = 0;
    	System.out.println("Asset count: "+results.size());
    	for(BusinessObject boAsset : results) {
    		...
    		if(boAsset instanceof Asset) {
    			...
    			System.out.println("Asset location counts: "+locs.size());
    			...
    			if(!remove) {
    				...
    				System.out.println("Removing asset: "+asset.getCapitalAssetNumber());
    			}
    		} else {
    			break;
    		}
    	...
    	System.out.println("Assets reviewed: "+count);
    	System.out.println("Results returned: "+resultsModified.size());
    ...
    protected List<? extends BusinessObject> getSearchResultsHelper(Map<String, String> fieldValues, boolean unbounded) {
        ...
        if(StringUtils.isNotBlank(fieldValues.get(CamsPropertyConstants.Asset.ASSET_LOCATION_TYPE_CODE))) {
        	unbounded = true;
