...
public class PurchaseOrderItem extends PurchasingItemBase {
    ...
    public PurchaseOrderItem(RequisitionItem ri, PurchaseOrderDocument po, RequisitionCapitalAssetItem reqCamsItem) {
        ...
        // KFSPTS-2257
        this.setControlled(ri.isControlled());
        this.setRadioactive(ri.isRadioactive());
        this.setRadioactiveMinor(ri.isRadioactiveMinor());
        this.setRecycled(ri.isRecycled());
        this.setGreen(ri.isGreen());
        this.setEnergyStar(ri.isEnergyStar());
        this.setSelectAgent(ri.isSelectAgent());
        this.setHazardous(ri.isHazardous());
        this.setToxin(ri.isToxin());
    }
