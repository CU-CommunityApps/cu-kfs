...
public interface PaymentRequestDao {
    ...
    /**
     * Retrieves a list of document numbers by purchase order id and status.
     * 
     * @param id - purchase order id
     * @return - list of document numbers
     */
    
    public List<String> getDocumentNumbersByStatusAndPurchaseOrderId(String status, boolean include, Integer id);
