 ...
 *
 */
public class RequisitionCommodityCodeValidation extends PurchasingCommodityCodeValidation {
    ...
    protected boolean commodityCodeIsRequired(PurApItem item) {
        ...
        if (!enableCommodityCode) {
            ...
            return getParameterService().getIndicatorParameter(RequisitionDocument.class, PurapRuleConstants.ITEMS_REQUIRE_COMMODITY_CODE_IND);
        }
    }
