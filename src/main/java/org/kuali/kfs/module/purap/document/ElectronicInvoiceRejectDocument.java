...
public class ElectronicInvoiceRejectDocument extends FinancialSystemTransactionalDocumentBase implements SessionDocument {
   ...
   */
    ...
    public void sanitizeRejectReasons() {
    	Iterator<ElectronicInvoiceRejectReason> it = invoiceRejectReasons.iterator();
    	...
    	while (it.hasNext()) {
    		ElectronicInvoiceRejectReason rejectReason = (ElectronicInvoiceRejectReason) it.next();
