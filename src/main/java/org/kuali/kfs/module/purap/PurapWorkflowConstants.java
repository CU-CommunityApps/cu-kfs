...
public class PurapWorkflowConstants {
    ...
    public static class RequisitionDocument {
        public enum NodeDetailEnum implements NodeDetails {
            ...
            CONTENT_REVIEW("Organization", PurapConstants.RequisitionStatuses.AWAIT_CONTENT_REVIEW, PurapConstants.RequisitionStatuses.DAPRVD_CONTENT), 
            ...
            CONTRACTS_AND_GRANTS_REVIEW("Award", PurapConstants.RequisitionStatuses.AWAIT_CONTRACTS_GRANTS_REVIEW, PurapConstants.RequisitionStatuses.DAPRVD_CONTRACTS_GRANTS), 
    ...
    public static class PurchaseOrderDocument {
        public enum NodeDetailEnum implements NodeDetails {
            ...
            DOCUMENT_TRANSMISSION("JoinRequiresBudgetReview", null, PurapConstants.PurchaseOrderStatuses.VOID), 
