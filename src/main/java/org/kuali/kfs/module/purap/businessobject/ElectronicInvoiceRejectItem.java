...
public class ElectronicInvoiceRejectItem extends PersistableBusinessObjectBase {
   ...
   */
    public ElectronicInvoiceRejectItem(ElectronicInvoiceRejectDocument electronicInvoiceRejectDocument, ElectronicInvoiceItem eii) {
        ...
        if (((eii.getSubTotalAmount() == null) || ("".equals(eii.getSubTotalAmount())))) {
            ...
            if (((this.invoiceItemQuantity != null) && ((BigDecimal.ZERO.compareTo(this.invoiceItemQuantity)) != 0)) && ((this.invoiceItemUnitPrice != null) && ((BigDecimal.ZERO.compareTo(this.invoiceItemUnitPrice)) != -1))) {
                ...
                // quantity is empty but unit cost exists... use it (allow 0 as a valid unit price)
    ...
    public BigDecimal getInvoiceItemSubTotalAmount() {
        ...
        // KFSPTS-1719 - add "0"
        else if (((this.invoiceItemQuantity == null) || ("".equals(this.invoiceItemQuantity) || ((BigDecimal.ZERO.compareTo(this.invoiceItemQuantity)) == 0))) && ((this.invoiceItemUnitPrice != null))) {
