...
public class ReceivingDaoOjb extends PlatformAwareDaoBaseOjb implements ReceivingDao {
    ...
    public List<LineItemReceivingDocument> getReceivingDocumentsForPOAmendment() {
        ...
        while (documents.hasNext()) {
            ...
            // TODO : add logging to investigate approveLineItemReceivingJob issue in stg
            LOG.info(" getReceivingDocumentsForPOAmendment doc id for approve line rec job " +document.getDocumentNumber());
