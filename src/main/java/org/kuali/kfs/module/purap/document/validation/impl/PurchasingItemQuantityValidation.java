...
public class PurchasingItemQuantityValidation extends GenericValidation {
    ...
    public boolean validate(AttributedDocumentEvent event) {
        ...
        if (ObjectUtils.isNotNull(itemForValidation.getItemLineNumber())) {
            errorPrefix = KFSPropertyConstants.DOCUMENT + "." + PurapPropertyConstants.ITEM + "[" + (itemForValidation.getItemLineNumber() - 1) + "]." + PurapPropertyConstants.ITEM_QUANTITY;
        }
        else {
            errorPrefix = KFSPropertyConstants.DOCUMENT + "." + PurapPropertyConstants.ITEM + PurapPropertyConstants.ITEM_QUANTITY;
        }
