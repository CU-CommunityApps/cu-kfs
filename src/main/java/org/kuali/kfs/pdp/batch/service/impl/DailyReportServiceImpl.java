...
public class DailyReportServiceImpl implements DailyReportService {
    ...
    public void runReport() {
        ...
        try {
            ...
            String totalForSubtitle = "";
            String parameterTotalForSubtitle = this.kualiConfigurationService.getPropertyString(PdpKeyConstants.DAILY_REPORT_SERVICE_TOTAL_FOR_SUBTITLE);
            ...
            for (Iterator iter = data.iterator(); iter.hasNext();) {
                ...
                if ( ! rows ) {
                    ...
                    totalForSubtitle = MessageFormat.format(parameterTotalForSubtitle, new Object[]{ this.paymentGroupService.getSortGroupName(this.paymentGroupService.getSortGroupId(sortTotal.getPaymentGroup())) });
