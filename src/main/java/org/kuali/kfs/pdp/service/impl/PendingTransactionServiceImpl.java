...
public class PendingTransactionServiceImpl implements PendingTransactionService {
    ...
    protected void populatePaymentGeneralLedgerPendingEntry(PaymentGroup paymentGroup, String achFdocTypeCode, String checkFdocTypeCod, boolean reversal) {
        ...
        for (PaymentDetail paymentDetail : paymentGroup.getPaymentDetails()) {
            ...
            if (StringUtils.equals(FDOC_TYP_CD_STOP_CHECK, checkFdocTypeCod) && (PurapConstants.PurapDocTypeCodes.PAYMENT_REQUEST_DOCUMENT.equalsIgnoreCase(paymentDetail.getFinancialDocumentTypeCode()) || PdpConstants.PdpDocumentTypes.DISBURSEMENT_VOUCHER.equalsIgnoreCase(paymentDetail.getFinancialDocumentTypeCode()) || PdpConstants.PdpDocumentTypes.CREDIT_MEMO.equalsIgnoreCase(paymentDetail.getFinancialDocumentTypeCode()))) {
                try {
