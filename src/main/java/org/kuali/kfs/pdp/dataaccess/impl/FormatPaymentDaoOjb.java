...
public class FormatPaymentDaoOjb extends PlatformAwareDaoBaseOjb implements FormatPaymentDao {
     ...
     */
    public void markPaymentsForFormat(PaymentProcess proc, List customers, Date paydate, String paymentTypes, String paymentDistribution) {
        ...
        if(PdpConstants.PaymentDistributions.PROCESS_ACH_ONLY.equals(paymentDistribution)) {
        ...
        else if(PdpConstants.PaymentDistributions.PROCESS_CHECK_ONLY.equals(paymentDistribution)) {
