...
/**
 * XXX: Overriding KIMServiceLocator to fix bug https://test.kuali.org/jira/browse/KULRICE-3721
...
public final class KIMServiceLocator {
	...
	public static Object getBean(String serviceName) {
		...
		return GlobalResourceLoader.getResourceLoader().getService(new QName("KIM", serviceName));
	}
