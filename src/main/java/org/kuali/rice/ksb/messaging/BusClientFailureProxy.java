...
/**
 * ====
 * CU Customization (CYNERGY-2283):
 * Customized the "isServiceRemovalException" method so that it always returns false,
 * as suggested by Eric Westfall and IU's Rice implementation.
 * ====
 */
public class BusClientFailureProxy extends BaseTargetedInvocationHandler {
	...
	// CU Customization (CYNERGY-2283): Modified this method so that all it does is return false.
