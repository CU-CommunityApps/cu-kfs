...
<kul:documentPage showDocumentInfo="true"
    ...
    <%--KFSPTS-974: original code kul:notes notesBo="${KualiForm.document.documentBusinessObject.boNotes}" noteType="${Constants.NoteTypeEnum.BUSINESS_OBJECT_NOTE_TYPE}" />   --%> 
