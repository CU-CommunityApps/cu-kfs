            ...
            <c:if test="${KualiForm.reportMode != 'requestImport'}">  
				...
				<tr>
					<td class="grid" class="infoline" colspan="2">
						<div align="center">
							<!-- NOTE:  Below the "onclick" was added to set the form to multipart so that the file will be transferred.  Also, the
										position of the "onclick" is critical in the tag.  Testing has revealed that placing the "onclick" at the end 
										of the HTML tag will cause it to be	ignored and not rendered to the browser -->
							<html:image property="methodToCall.submit" onclick="this.form.encoding='multipart/form-data'; return true;" src="kr/static/images/buttonsmall_submit.gif" title="Import File" alt="Import File" styleClass="tinybutton" /> &nbsp;&nbsp;&nbsp;
