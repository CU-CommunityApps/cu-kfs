          ...
          <table cellpadding=0 class="datatable" summary=""> 
            <tr>
              <td class="bord-l-b" style="padding: 4px;">
                ...
                <html:image property="methodToCall.uploadFile.anchor${currentTabIndex}" onclick="this.form.encoding='multipart/form-data'; return true;" src="${ConfigProperties.externalizable.images.url}tinybutton-loaddoc.gif" styleClass="tinybutton" alt="upload file" title="upload file"/>
              </td>
            </tr>
          </table>
        </div>
