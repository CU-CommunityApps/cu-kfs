...
<div class="body">
    ...
    <ul class="chan">
	    ...
	    <li><portal:portalLink displayTitle="true" title="Current Fund Balance" url="kr/lookup.do?methodToCall=start&businessObjectClassName=edu.cornell.kfs.gl.businessobject.CurrentAccountBalance&docFormKey=88888888&returnLocation=portal.do&hideReturnLink=true" /></li>
