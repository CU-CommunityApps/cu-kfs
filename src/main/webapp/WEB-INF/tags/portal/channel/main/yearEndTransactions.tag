...
<div class="body">
    ...
    <ul class="chan">
		...
		<li><portal:portalLink displayTitle="true" title="Year End Journal Voucher" url="financialYearEndJournalVoucher.do?methodToCall=docHandler&command=initiate&docTypeName=YEJV" /></li>
