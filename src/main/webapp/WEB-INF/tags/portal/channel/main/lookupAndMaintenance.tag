...
<div class="body">
    ...
    <ul class="chan">
	    ...
	    <li><portal:portalLink displayTitle="true" title="Account Global" url="kr/maintenance.do?methodToCall=start&businessObjectClassName=edu.cornell.kfs.coa.businessobject.CuAccountGlobal" /></li>	
	    ...
	    <li><portal:portalLink displayTitle="true" title="Account Delegate Global" url="kr/maintenance.do?methodToCall=start&businessObjectClassName=edu.cornell.kfs.coa.businessobject.CuAccountDelegateGlobal" /></li>
	    ...
	    <li><portal:portalLink displayTitle="true" title="Object Code Global" url="kr/maintenance.do?methodToCall=start&businessObjectClassName=edu.cornell.kfs.coa.businessobject.CUObjectCodeGlobal" /></li>
	    ...
	    <li><portal:portalLink displayTitle="true" title="Organization Global" url="kr/maintenance.do?methodToCall=start&businessObjectClassName=edu.cornell.kfs.coa.businessobject.OrganizationGlobal" /></li>
	    ...
	    <li><portal:portalLink displayTitle="true" title="Sub-Account Global" url="kr/maintenance.do?methodToCall=start&businessObjectClassName=edu.cornell.kfs.coa.businessobject.SubAccountGlobal" /></li>	
    ...
    <c:when test="${ConfigProperties['module.contracts.and.grants.enabled'] == 'true'}">
		...
		<ul class="chan">
			<li><portal:portalLink displayTitle="true" title="Award" url="kr/lookup.do?methodToCall=start&businessObjectClassName=edu.cornell.kfs.module.cg.businessobject.CuAward&docFormKey=88888888&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true" /></li>
