...
<div class="body">
    ...
    <ul class="chan">
    	<li><portal:portalLink displayTitle="true" title="Document Requeuer File Upload" url="batchUpload.do?methodToCall=start&batchUpload.batchInputTypeName=documentRequeuerFlatFileInputFileType" /></li>
