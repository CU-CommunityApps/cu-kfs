...
<div class="body">
    ...
    <ul class="chan">
       ...
       <!-- KFSPTS-1891 -->
       <li><portal:portalLink displayTitle="true" title="Payment Method" url="kr/lookup.do?methodToCall=start&businessObjectClassName=edu.cornell.kfs.fp.businessobject.PaymentMethod&docFormKey=88888888&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true" /></li>           </ul>
</div>
