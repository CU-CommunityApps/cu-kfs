...
<div class="body">
    ...
    <ul class="chan">
        ...
        <li><portal:portalLink displayTitle="true" title="Incoming Wire or ACH Mapping" url="kr/lookup.do?methodToCall=start&businessObjectClassName=edu.cornell.kfs.fp.businessobject.IncomingWireAchMapping&docFormKey=88888888&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true" /></li>
