...
<div class="body">
	<ul class="chan">
		...
		<li>
			<portal:portalLink displayTitle="true" title="Dept - KFS Organization Crosswalk"
				url="kr/lookup.do?methodToCall=start&businessObjectClassName=edu.cornell.kfs.module.bc.businessobject.DeptOrgCrosswalk&docFormKey=88888888&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true" />
		</li>
