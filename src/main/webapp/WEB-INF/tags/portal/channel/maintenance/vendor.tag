...
<div class="body">
    <ul class="chan">
        ...
        <li><portal:portalLink displayTitle="true" title="Chapter 4 Status Code" url="kr/lookup.do?methodToCall=start&businessObjectClassName=edu.cornell.kfs.vnd.businessobject.CuVendorChapter4Status&docFormKey=88888888&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true" /></li>     
    </ul>
</div>
