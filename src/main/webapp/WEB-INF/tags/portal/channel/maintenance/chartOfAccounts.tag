...
<div class="body">
    <ul class="chan">
        ...
        <li><portal:portalLink displayTitle="true" title="Sub-Fund Program" url="kr/lookup.do?methodToCall=start&businessObjectClassName=edu.cornell.kfs.coa.businessobject.SubFundGroupProgram&docFormKey=88888888&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true" /></li>
