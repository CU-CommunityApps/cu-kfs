    ...
    <div class="tab-container" align=center > 
		...
		<table cellpadding=0 class="datatable" summary="Payment Section">			            
            ...
            <tr>
              ...
              <td colspan="3" class="datacell">              	
                <kul:htmlControlAttribute attributeEntry="${payeeAttributes.disbVchrPayeeIdNumber}" property="document.dvPayeeDetail.disbVchrPayeeIdNumber" readOnly="true" /> <kul:htmlControlAttribute attributeEntry="${payeeAttributes.extension.disbVchrPayeeIdType}" property="document.dvPayeeDetail.extension.disbVchrPayeeIdTypeDisplay" readOnly="true" />
