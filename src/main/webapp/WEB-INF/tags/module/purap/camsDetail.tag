      ...
      <table class="datatable" summary="System Detail" cellpadding=0 cellspacing=0 style="width:100%">
	    ...
	    <tr>
	      ...
	      <td class="datacell" align="left" colspan="3">
			<kul:htmlControlAttribute attributeEntry="${camsAssetAttributes.capitalAssetNumber}" property="document.purchasingCapitalAssetItems[${camsItemIndex}].newPurchasingItemCapitalAssetLine.capitalAssetNumber" readOnly="${!(fullEntryMode or amendmentEntry or enableCa) or poItemInactive}" tabindexOverride="${tabindexOverrideBase + 0}"/>		
	      	&nbsp;
        ...
        <tr>
          ...
          <td align="right" class="datacell">
            <kul:htmlControlAttribute attributeEntry="${camsSystemAttributes.capitalAssetManufacturerName}" property="${camsAssetSystemProperty}.capitalAssetManufacturerName" readOnly="${!(fullEntryMode or amendmentEntry or enableCa) or poItemInactive}" tabindexOverride="${tabindexOverrideBase + 3}"/>
            <c:if test="${(fullEntryMode or amendmentEntry or enableCa) and !poItemInactive}">
        ...
        <tr>
          ...
          <td align="right" valign="middle" class="datacell">
              <kul:htmlControlAttribute attributeEntry="${camsSystemAttributes.capitalAssetTypeCode}" property="${camsAssetSystemProperty}.capitalAssetTypeCode" readOnly="${!(fullEntryMode or amendmentEntry or enableCa) or poItemInactive or notCurrentYear}" tabindexOverride="${tabindexOverrideBase + 0}"/>		
              <c:if test="${(fullEntryMode or amendmentEntry or enableCa) and !poItemInactive and !notCurrentYear}">
          ...
          <td align="right" class="datacell">
            <kul:htmlControlAttribute attributeEntry="${camsSystemAttributes.capitalAssetModelDescription}" property="${camsAssetSystemProperty}.capitalAssetModelDescription" readOnly="${!(fullEntryMode or amendmentEntry or enableCa) or poItemInactive}" tabindexOverride="${tabindexOverrideBase + 3}"/>
		  </td>
        </tr>
        <c:if test="${KualiForm.purchasingCapitalAssetCountAssetNumberAvailability eq availability}">
	        <tr>
	            ...
	            <td class="datacell">
	                <kul:htmlControlAttribute attributeEntry="${camsSystemAttributes.capitalAssetCountAssetNumber}" property="${camsAssetSystemProperty}.capitalAssetCountAssetNumber" readOnly="${!(fullEntryMode or amendmentEntry or enableCa) or poItemInactive}" tabindexOverride="${tabindexOverrideBase + 0}"/>
	            </td>       
	            <th>&nbsp;</th>
	            <td class="datacell">&nbsp;</td>
	        </tr>
