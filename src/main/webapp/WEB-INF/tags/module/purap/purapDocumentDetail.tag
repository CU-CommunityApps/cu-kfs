...
<c:set var="contentEntry" value="${(not empty KualiForm.editingMode['contentReview'])}" />
    ...
    <c:if test="${not paymentRequest}">
	    <tr>
	        ...
	        <td>
	            ...
	            <c:if test="${(fullEntryMode or amendmentEntry or contentEntry) and not (contentReadOnly or internalPurchasingReadOnly)}" >
