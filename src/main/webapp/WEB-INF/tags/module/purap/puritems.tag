			...
			<tr>
				...
				<td colspan="6" class="subhead" align="right" nowrap="nowrap" style="border-left: none;">
                		...
                		<!--
                  		...
                  		document.write(
                    		...
                    		'<div id="uploadDiv" style="display:none;" >' +
                      		...
                      		'<html:image property="methodToCall.importItems" onclick="setEncoding(); return true;" src="${ConfigProperties.kr.externalizable.images.url}tinybutton-add1.gif"
					...
					<NOSCRIPT>
						...
						<html:image property="methodToCall.importItems" onclick="this.form.encoding='multipart/form-data'; return true;" src="${ConfigProperties.kr.externalizable.images.url}tinybutton-add1.gif" alt="add imported items" title="add imported items" />
					</NOSCRIPT>
				</td>
			</tr>
