	...
	<table cellpadding="0" cellspacing="0" title="view/edit document overview information" summary="view/edit document overview information">
		<tr>
			<th align="right" valign="middle" class="neutral">
				<kul:htmlAttributeLabel attributeEntry="${docHeaderAttributes.documentDescription}"/>
			</th>
			<td align="left" valign="middle" class="neutral">
				<kul:htmlControlAttribute property="document.documentHeader.documentDescription" attributeEntry="${docHeaderAttributes.documentDescription}" readOnly="${!KualiForm.documentActions[Constants.KUALI_ACTION_CAN_EDIT_DOCUMENT_OVERVIEW]}"/>
			</td>
		</tr>
		<tr>
			<th align="right" valign="middle" class="neutral">
				<kul:htmlAttributeLabel attributeEntry="${iWantDocAttributes.explanation}"/>
			</th>
			<td align="left" valign="middle" class="neutral">
		...
		<tr>
			<td colspan="2" class="neutral" style="color: blue; font-family:Verdana, Verdana, serif; font-size: 12px;font-style: italic">
				<div>
					<b>NOTE:</b> The Business Purpose should tie the purchase to the account being charged; what is being purchased, why it is being purchased, how it will be used.
					<ul>
