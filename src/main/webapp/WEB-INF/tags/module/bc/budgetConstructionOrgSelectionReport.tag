        ...
        <table class="datatable" border="0" width="100%" cellpadding="0" cellspacing="0">
        	<tr>
              ...
              <tr>
                <td>
                  <div align="center">
                    <html:image property="methodToCall.performReport.(((SIPExport)))" src="${ConfigProperties.externalizable.images.url}tinybutton-view.gif" title="SIP Export" alt="SIP Export" styleClass="tinybutton" />
                  </div>
                </td>
                <td>SIP Export</td>
              </tr>
