...
<c:set var="bcCSFAttributes" value="${DataDictionary['BudgetConstructionCalculatedSalaryFoundationTracker'].attributes}" />
...
<table border="0" cellpadding="0" cellspacing="0" style="width: ${tableWidth}; text-align: left; margin-left: auto; margin-right: auto;">    
	<tr>
	    ...
	    <kul:htmlAttributeHeaderCell attributeEntry="${bcCSFAttributes.csfFundingStatusCode}"/>
	</tr>
	...
	<tr> 
		...
		<td class="datacell" rowSpan="1">        		
		    <bc:pbglLineDataCellDetail detailField="effectiveCSFTracker.csfFundingStatusCode" 
		    	accountingLine="${fundingLineName}" dataFieldCssClass="nowrap" />
		</td>
	</tr>
