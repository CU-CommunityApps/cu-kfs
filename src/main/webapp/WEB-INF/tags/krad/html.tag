...
<html lang="en">
  ...
  <head>
    ...
    <meta http-equiv="expires" content="Fri, 01 Jan 2010 05:00:00 GMT">
    ...
    <%-- ==== CU Customization: Forcibly include custom iframe_resize script. ==== --%>
    <script type="text/javascript" src="${pageContext.request.contextPath}/kr/scripts/iframe_resize.js"></script>
    <%-- ==== End CU Customization ==== --%>
