...
function returnLookupResultReload(aElement) {
    // ==== CU Customization: Removed easyXDM-related block as part of Kuali's CONTRIB-101 frame resizing enhancement ====
    if (parent.parent.jQuery('#iframeportlet').length > 0) {
