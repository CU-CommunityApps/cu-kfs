...
class PaymentWorksDtoToPaymentWorksVendorConversionServiceImplTest {
    ...
    private static final String PMW_ACH_BANK_ACCT_NUMBER_VALUE_WITH_DASH = "123-5-7";
    private static final String PMW_ACH_BANK_ACCT_NUMBER_SANITIZED_VALUE = "12357";
    private static final String PMW_ACH_BANK_ACCT_NUMBER_VALUE_WITHOUT_DASH = "1234567";
    ...
    public void testSanitizeACHBankAccountNumberValueWithDash() {
        String actualResults = paymentWorksDtoToPaymentWorksVendorConversionServiceImpl.sanitizeBankAcctBankAccountNumberValue(PMW_ACH_BANK_ACCT_NUMBER_VALUE_WITH_DASH);
        assertEquals(PMW_ACH_BANK_ACCT_NUMBER_SANITIZED_VALUE, actualResults);
    }
    
    @Test
    public void testSanitizeACHBankAccountNumberValueWithoutDash() {
        String actualResults = paymentWorksDtoToPaymentWorksVendorConversionServiceImpl.sanitizeBankAcctBankAccountNumberValue(PMW_ACH_BANK_ACCT_NUMBER_VALUE_WITHOUT_DASH);
        assertEquals(PMW_ACH_BANK_ACCT_NUMBER_VALUE_WITHOUT_DASH, actualResults);
    }
