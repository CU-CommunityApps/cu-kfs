...
public enum CuVendorWorkdayServiceEnum {
    ...
    SSN_NO_HYPHENS_INCLUDE_TERMINATED("000000000", "1", "001", true, "xyz321", "1", "123456789", "06-01-1998"),
    SSN_WITH_HYPHENS_INCLUDE_TERMINATED("111-22-3333", "1", "002", true, "abc123", "1", "98654321", "06-01-2019"),
    SSN_NO_HYPHENS_EXCLUDE_TERMINATED("111111111", "0", "003", false, "def987", "0", "456789321", "07-01-2024", "08-01-2024", "08-01-2024"),
    SSN_WITH_HYPHENS_EXCLUDE_TERMINATED("111-22-3333", "0", "004", false, "stu666", "0", "66666", "01-01-2025", "01-02-2025", "01-02-2025"),
    EMPTY_SSN_INCLUDE_TERMINATED(StringUtils.EMPTY, "1", "005", false),
    EMPTY_SSN_EMPTY_TERMINATED(StringUtils.EMPTY, StringUtils.EMPTY, "006", false),
    SSN_WITH_HYPHENS_NULL_TERMINATED("222-77-9999", null, "007", false), 
    NULL_SSN_INCLUDE_TERMINATED(null, "1", "008", false),
    NULL_SSN_NULL_TERMINATED(null, null, "009", false);

    public final String ssn;
    public final String includeTerminatedWorkers;
    public final String documentId;
    public final boolean activeRecord;
    ...
    private CuVendorWorkdayServiceEnum(String ssn, String includeTerminatedWorkers, String documentId,
        ...
        this(ssn, includeTerminatedWorkers, documentId, activeRecord, StringUtils.EMPTY, StringUtils.EMPTY,
                StringUtils.EMPTY, StringUtils.EMPTY);
    }

    private CuVendorWorkdayServiceEnum(String ssn, String includeTerminatedWorkers, String documentId,
            boolean activeRecord, String netID, String activeStatus, String employeeID, String hireDate) {
        this(ssn,includeTerminatedWorkers, documentId, activeRecord, netID, activeStatus, employeeID, hireDate, null, null);
    }
