...
public enum PaymentRequestDtoFixture {
    ...
    VALIDATION_TEST_ITEMS_TOTAL_EQUALS_INVOICE_TOTAL(StringUtils.EMPTY, "1234-1", "98769",
            "11/25/2025", "11/26/2025",
            "invoiceNumber", "1000", StringUtils.EMPTY, StringUtils.EMPTY, StringUtils.EMPTY,
            null, StringUtils.EMPTY, null, StringUtils.EMPTY, null,
            StringUtils.EMPTY, buildItems(PaymentRequestLineItemDtoFixture.ITEM_1_10_100),
            ...
            buildMessageList(), buildMessageList()),
    VALIDATION_TEST_ITEMS_TOTAL_NOT_EQUAL_INVOICE_TOTAL(StringUtils.EMPTY, "1234-1", "98769",
            "11/25/2025", "11/26/2025",
            "invoiceNumber", "500", StringUtils.EMPTY, StringUtils.EMPTY, StringUtils.EMPTY,
            null, StringUtils.EMPTY, null, StringUtils.EMPTY, null,
            StringUtils.EMPTY, buildItems(PaymentRequestLineItemDtoFixture.ITEM_1_10_100),
            buildNotes(PaymentRequestNoteDtoFixture.NOTE_VALID), false,
    ...
    VALIDATION_TEST_ITEMS_PLUS_FREIGHT_EQUALS_INVOICE(StringUtils.EMPTY, "1234-1", "98769",
            ...
            buildNotes(PaymentRequestNoteDtoFixture.NOTE_VALID), true,
            buildMessageList(), buildMessageList()),
    VALIDATION_TEST_ITEMS_PLUS_FREIGHT_NOT_EQUAL_INVOICE(StringUtils.EMPTY, "1234-1", "98769",
            "11/25/2025", "11/26/2025",
            "invoiceNumber", "1200", StringUtils.EMPTY, StringUtils.EMPTY, StringUtils.EMPTY,
            "50", "Freight", "75", "Misc", "25",
            "Shipping", buildItems(PaymentRequestLineItemDtoFixture.ITEM_1_10_100),
            buildNotes(PaymentRequestNoteDtoFixture.NOTE_VALID), false,
