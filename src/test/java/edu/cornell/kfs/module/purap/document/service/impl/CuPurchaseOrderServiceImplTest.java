...
public class CuPurchaseOrderServiceImplTest extends KualiIntegTestBase {

	private static final Logger LOG = LogManager.getLogger(CuPurchaseOrderServiceImplTest.class);
