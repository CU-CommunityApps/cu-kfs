...
public class CuRequisitionServiceImplTest extends KualiTestBase {
	...
	protected void setUp() throws Exception {
		...
		cuRequisitionServiceImpl = (CuRequisitionServiceImpl)TestUtils.getUnproxiedService("requisitionService");
	...
	public void testCheckAPORulesPerItemForCommodityCodes_Active() throws WorkflowException{
		RequisitionDocument requisitionDocument = RequisitionFixture.REQ_NON_B2B_CAP_ASSET_ITEM.createRequisition();
		String result = cuRequisitionServiceImpl.checkAPORulesPerItemForCommodityCodes(RequisitionItemFixture.REQ_ITEM.createRequisitionItem(), requisitionDocument.getVendorDetail().getVendorCommodities(), true);
	...
	public void testCheckAPORulesPerItemForCommodityCodes_Inactive() throws WorkflowException{
		...
		String result = cuRequisitionServiceImpl.checkAPORulesPerItemForCommodityCodes(RequisitionItemFixture.REQ_ITEM_INACTIVE_COMM_CD.createRequisitionItem(), requisitionDocument.getVendorDetail().getVendorCommodities(), true);
