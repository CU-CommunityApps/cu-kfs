...
public class CuB2BShoppingServiceImplIntegTest extends KualiIntegTestBase {
	...
	public void testCreateRequisitionItemTruncateDescription() {
		...
		assertTrue(requisitionItem.isRecycled());
		assertTrue(requisitionItem.isEnergyStar());
		assertTrue(requisitionItem.getItemDescription().length() == CuPurapTestConstants.REQUISITION_ITEM_DESCRIPTION_MAX_LENGTH);
	}
