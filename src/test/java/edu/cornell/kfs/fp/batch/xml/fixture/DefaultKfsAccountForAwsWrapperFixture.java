...
public class DefaultKfsAccountForAwsWrapperFixture {
    ...
    public static DefaultKfsAccountForAwsResultWrapper generateExpectedDefaultKfsAccountForAwsResultWrapperObject() {
        ...
        defaultKfsAccountForAwsResultWrapper.setDefaultKfsAccountForAws(defaultKfsAccountForAwsList);
