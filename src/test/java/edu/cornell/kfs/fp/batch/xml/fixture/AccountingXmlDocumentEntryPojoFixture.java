...
public enum AccountingXmlDocumentEntryPojoFixture {
    GOOD_DATA_ALL_ITEMS(1, KFSConstants.FinancialDocumentTypeCodes.SERVICE_BILLING,
            "Good Description", "Good Explanation for ducment entry unit tests", true),
    BAD_INDEX_TEST(0, KFSConstants.FinancialDocumentTypeCodes.SERVICE_BILLING,
            "Good Description", "Good Explanation for ducment entry unit tests", false),
    BAD_DOCUMENT_TYPE_TEST(1, null,
            "Good Description", "Good Explanation for ducment entry unit tests", false),
    BAD_DESCRIPTION_TEST(1, KFSConstants.FinancialDocumentTypeCodes.SERVICE_BILLING,
            null, "Good Explanation for ducment entry unit tests", false),
    BAD_EXPLANATION_TEST(1, KFSConstants.FinancialDocumentTypeCodes.SERVICE_BILLING,
