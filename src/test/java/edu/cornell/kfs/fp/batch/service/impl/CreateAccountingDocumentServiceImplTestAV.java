...
public class CreateAccountingDocumentServiceImplTestAV extends CreateAccountingDocumentServiceImplBase {
    ...
    protected static class AVTestCreateAccountingDocumentServiceImpl extends TestCreateAccountingDocumentServiceImpl {
        public AVTestCreateAccountingDocumentServiceImpl(
            ...
            super(personService, downloadAttachmentService, configurationService, fiscalYearFunctionControlService,
                    universityDateService, accountingPeriodService, dateTimeService);
        }
        protected AccountingDocumentGenerator<?> buildAccountingDocumentGenerator(
            ...
            AuxiliaryVoucherDocumentGenerator avGenerator = (AuxiliaryVoucherDocumentGenerator) super.buildAccountingDocumentGenerator(generatorConstructor);
