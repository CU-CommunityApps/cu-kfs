...
public enum DefaultKfsAccountForAwsFixture {
    ...
    AWS_CDE_KFS_ACCOUNT_STRING_IT_R589966_NONCA_1000_BAD("CDE", "IT*R589966*NONCA*1000*BAD*EB-PLGIFT*AEH56"),
    AWS_CDEE_KFS_ACCOUNT_STRING_IT_R589966_NONCA_1000_10X("CDEE", "IT*R589966*NONCA*1000*10X*EB-PLGIFT*AEH56"),
