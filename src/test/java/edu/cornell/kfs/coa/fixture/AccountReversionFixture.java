...
public enum AccountReversionFixture {
	...
	ACCOUNT_REVERSION_GOOD("G254700", 2014, "IT", "IT", "G104895", false, "IT",
			"G104895"),

	ACCOUNT_REVERSION_UPLOAD("1008000", "IT", "IT", "B023005", false, "IT",
			"B023005");
	...
	private AccountReversionFixture(String accountNumber,
			String chartOfAccountsCode,
			String budgetReversionChartOfAccountsCode,
			String budgetReversionAccountNumber,
			boolean carryForwardByObjectCodeIndicator,
			String cashReversionFinancialChartOfAccountsCode,
			String cashReversionAccountNumber) {
		this.accountNumber = accountNumber;
		this.universityFiscalYear = Integer.parseInt(TestUtils
				.getParameterService().getParameterValueAsString("KFS-COA",
						"Reversion", "ACCOUNT_REVERSION_FISCAL_YEAR"));
		;
	...
	public AccountReversion createAccountReversion() {
		...
		accountReversion
				.setBudgetReversionChartOfAccountsCode(this.budgetReversionChartOfAccountsCode);
		accountReversion
				.setBudgetReversionAccountNumber(this.budgetReversionAccountNumber);
		accountReversion
				.setCarryForwardByObjectCodeIndicator(this.carryForwardByObjectCodeIndicator);
		accountReversion
				.setCashReversionFinancialChartOfAccountsCode(this.cashReversionFinancialChartOfAccountsCode);
		accountReversion
				.setCashReversionAccountNumber(this.cashReversionAccountNumber);
		return accountReversion;
	}

	public AccountReversion createAccountReversion(
			BusinessObjectService businessObjectService) {
		return (AccountReversion) businessObjectService.retrieve(this
				.createAccountReversion());
	}
}