...
public class ReversionUnitOfWorkServiceImplIntegTest extends KualiIntegTestBase {
    ...
    private void createUnitOfWork() {
        ...
        integTestSqlDao.sqlCommand(insertUnitOfWorkSql);
    }
    ...
    private void createCategoryAmounts() {
        ...
        integTestSqlDao.sqlCommand(insertCategoryAmtSql);
    }

    private boolean categoryAmountExists() {
        List results = integTestSqlDao.sqlSelect("select * from GL_RVRSN_CTGRY_AMT_T where FIN_COA_CD = 'IT' and ACCOUNT_NBR = '1003000' and SUB_ACCT_NBR = '-----'");
    ...
    private boolean unitOfworkExists() {
        List results = integTestSqlDao.sqlSelect("select * from GL_RVRSN_UNIT_WRK_T where FIN_COA_CD = 'IT' and ACCOUNT_NBR = '1003000' and SUB_ACCT_NBR = '-----'");
