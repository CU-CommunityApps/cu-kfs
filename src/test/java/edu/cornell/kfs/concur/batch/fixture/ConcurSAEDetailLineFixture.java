...
public enum ConcurSAEDetailLineFixture {
    ...
    DEFAULT_PERSONAL_CREDIT(DEFAULT_PERSONAL_DEBIT, null, ConcurConstants.CREDIT, -50.00,
            buildOverride(LineField.JOURNAL_PAYER_PAYMENT_TYPE_NAME, ConcurConstants.USER_PAYMENT_TYPE),
            buildOverride(LineField.JOURNAL_PAYEE_PAYMENT_TYPE_NAME, ConcurConstants.UNIVERSITY_PAYMENT_TYPE)),
    DEFAULT_PERSONAL_REFUND_DEBIT(DEFAULT_PERSONAL_DEBIT, null,
    ...
    DEFAULT_PERSONAL_REFUND_CREDIT(DEFAULT_PERSONAL_CREDIT, null,
    ...
    PERSONAL_CHARGE_AND_CREDIT_TEST_LINE1(DEFAULT_CORP_CARD_DEBIT, ConcurSAEFileFixture.PERSONAL_CHARGE_AND_CREDIT_TEST, 16.00),
    PERSONAL_CHARGE_AND_CREDIT_TEST_LINE2(DEFAULT_DEBIT, ConcurSAEFileFixture.PERSONAL_CHARGE_AND_CREDIT_TEST, 75.00),
    PERSONAL_CHARGE_AND_CREDIT_TEST_LINE3(DEFAULT_PERSONAL_DEBIT, ConcurSAEFileFixture.PERSONAL_CHARGE_AND_CREDIT_TEST, 13.00),
    PERSONAL_CHARGE_AND_CREDIT_TEST_LINE4(DEFAULT_PERSONAL_CREDIT, ConcurSAEFileFixture.PERSONAL_CHARGE_AND_CREDIT_TEST, -13.00),
    PERSONAL_CHARGE_AND_CREDIT_TEST_LINE5(DEFAULT_PERSONAL_REFUND_DEBIT, ConcurSAEFileFixture.PERSONAL_CHARGE_AND_CREDIT_TEST, 13.00),
    PERSONAL_CHARGE_AND_CREDIT_TEST_LINE6(DEFAULT_PERSONAL_REFUND_CREDIT, ConcurSAEFileFixture.PERSONAL_CHARGE_AND_CREDIT_TEST, -13.00),
