...
public enum ConcurOriginEntryFixture {
    ...
    UNIQUENESS_TEST_OFFSET1(DEFAULT_CASH_OFFSET, ConcurCollectorBatchFixture.UNIQUENESS_TEST, 150.00),
    ...
    PENDING_CLIENT_TEST_ENTRY1(DEFAULT_DEBIT, ConcurCollectorBatchFixture.PENDING_CLIENT_TEST, 110.00,
            buildOverride(LineField.OBJECT_CODE, ParameterTestValues.OBJECT_CODE_OVERRIDE)),
    PENDING_CLIENT_TEST_OFFSET1(DEFAULT_CASH_OFFSET, ConcurCollectorBatchFixture.PENDING_CLIENT_TEST, 110.00),
    ...
    CASH_AND_CARD_TEST_ENTRY1(DEFAULT_DEBIT, ConcurCollectorBatchFixture.CASH_AND_CARD_TEST, 105.00),
    ...
    MULTIPLE_CASH_ADVANCE_TEST_ENTRY1(DEFAULT_DEBIT, ConcurCollectorBatchFixture.MULTIPLE_CASH_ADVANCE_TEST, 90.00),
    ...
    PERSONAL_WITHOUT_CASH_TEST_OFFSET1(DEFAULT_PREPAID_OFFSET, ConcurCollectorBatchFixture.PERSONAL_WITHOUT_CASH_TEST, 115.00),
    PERSONAL_WITHOUT_CASH_TEST_OFFSET2(DEFAULT_PERSONAL_OFFSET, ConcurCollectorBatchFixture.PERSONAL_WITHOUT_CASH_TEST),

    CASH_EXCEEDS_PERSONAL_TEST_ENTRY1(DEFAULT_DEBIT, ConcurCollectorBatchFixture.CASH_EXCEEDS_PERSONAL_TEST, 142.88),
    CASH_EXCEEDS_PERSONAL_TEST_OFFSET1(DEFAULT_PREPAID_OFFSET, ConcurCollectorBatchFixture.CASH_EXCEEDS_PERSONAL_TEST, 115.00),
    CASH_EXCEEDS_PERSONAL_TEST_OFFSET2(DEFAULT_CASH_OFFSET, ConcurCollectorBatchFixture.CASH_EXCEEDS_PERSONAL_TEST, 27.88),

    CASH_EQUALS_PERSONAL_TEST_ENTRY1(DEFAULT_DEBIT, ConcurCollectorBatchFixture.CASH_EQUALS_PERSONAL_TEST, 142.88),
    CASH_EQUALS_PERSONAL_TEST_OFFSET1(DEFAULT_PREPAID_OFFSET, ConcurCollectorBatchFixture.CASH_EQUALS_PERSONAL_TEST, 142.88),

    PERSONAL_EXCEEDS_CASH_TEST_ENTRY1(DEFAULT_DEBIT, ConcurCollectorBatchFixture.PERSONAL_EXCEEDS_CASH_TEST, 131.88),
    PERSONAL_EXCEEDS_CASH_TEST_OFFSET1(DEFAULT_PREPAID_OFFSET, ConcurCollectorBatchFixture.PERSONAL_EXCEEDS_CASH_TEST, 142.88),
    PERSONAL_EXCEEDS_CASH_TEST_OFFSET4(DEFAULT_PERSONAL_OFFSET, ConcurCollectorBatchFixture.PERSONAL_EXCEEDS_CASH_TEST, 11.00),

    PERSONAL_AND_CASH_ADVANCE_TEST_ENTRY1(DEFAULT_DEBIT, ConcurCollectorBatchFixture.PERSONAL_AND_CASH_ADVANCE_TEST, 302.00),
    PERSONAL_AND_CASH_ADVANCE_TEST_OFFSET1(DEFAULT_PREPAID_OFFSET, ConcurCollectorBatchFixture.PERSONAL_AND_CASH_ADVANCE_TEST, 138.00),
    PERSONAL_AND_CASH_ADVANCE_TEST_OFFSET2(DEFAULT_CASH_OFFSET, ConcurCollectorBatchFixture.PERSONAL_AND_CASH_ADVANCE_TEST, 74.00),
    ...
    PERSONAL_CHARGE_AND_RETURN_TEST_ENTRY1(DEFAULT_DEBIT, ConcurCollectorBatchFixture.PERSONAL_CHARGE_AND_RETURN_TEST, 91.00),
    ...
    PERSONAL_CHARGE_AND_PARTIAL_RETURN_TEST_ENTRY1(DEFAULT_DEBIT, ConcurCollectorBatchFixture.PERSONAL_CHARGE_AND_PARTIAL_RETURN_TEST, 91.00),
    PERSONAL_CHARGE_AND_PARTIAL_RETURN_TEST_OFFSET1(DEFAULT_PREPAID_OFFSET, ConcurCollectorBatchFixture.PERSONAL_CHARGE_AND_PARTIAL_RETURN_TEST, 17.00),
    PERSONAL_CHARGE_AND_PARTIAL_RETURN_TEST_OFFSET2(DEFAULT_CASH_OFFSET, ConcurCollectorBatchFixture.PERSONAL_CHARGE_AND_PARTIAL_RETURN_TEST, 74.00),

    ATM_CASH_ADVANCE_TEST_ENTRY1(DEFAULT_DEBIT, ConcurCollectorBatchFixture.ATM_CASH_ADVANCE_TEST, 4.00),
    ATM_CASH_ADVANCE_TEST_CA_ENTRY1(DEFAULT_ATM_CASH_ADVANCE_CREDIT, ConcurCollectorBatchFixture.ATM_CASH_ADVANCE_TEST, 4.00),

    CASH_EXCEEDS_ATM_ADVANCE_TEST_ENTRY1(DEFAULT_DEBIT, ConcurCollectorBatchFixture.CASH_EXCEEDS_ATM_ADVANCE_TEST, 9.10),
    CASH_EXCEEDS_ATM_ADVANCE_TEST_OFFSET1(DEFAULT_CASH_OFFSET, ConcurCollectorBatchFixture.CASH_EXCEEDS_ATM_ADVANCE_TEST, 5.10),
    CASH_EXCEEDS_ATM_ADVANCE_TEST_CA_ENTRY1(DEFAULT_ATM_CASH_ADVANCE_CREDIT, ConcurCollectorBatchFixture.CASH_EXCEEDS_ATM_ADVANCE_TEST, 4.00),

    ATM_CASH_ADVANCE_WITH_FEE_TEST_ENTRY1(DEFAULT_DEBIT, ConcurCollectorBatchFixture.ATM_CASH_ADVANCE_WITH_FEE_TEST, 4.00),
    ATM_CASH_ADVANCE_WITH_FEE_TEST_ENTRY2(DEFAULT_ATM_FEE_DEBIT, ConcurCollectorBatchFixture.ATM_CASH_ADVANCE_WITH_FEE_TEST, 3.50),
    ATM_CASH_ADVANCE_WITH_FEE_TEST_CA_ENTRY1(DEFAULT_ATM_CASH_ADVANCE_CREDIT, ConcurCollectorBatchFixture.ATM_CASH_ADVANCE_WITH_FEE_TEST, 7.50),

    ATM_CASH_ADVANCE_UNUSED_TEST_ENTRY1(DEFAULT_DEBIT, ConcurCollectorBatchFixture.ATM_CASH_ADVANCE_UNUSED_TEST, 4.00),
    ATM_CASH_ADVANCE_UNUSED_TEST_CA_ENTRY1(DEFAULT_ATM_CASH_ADVANCE_CREDIT, ConcurCollectorBatchFixture.ATM_CASH_ADVANCE_UNUSED_TEST, 10.00),
    ATM_CASH_ADVANCE_UNUSED_TEST_OFFSET1(DEFAULT_UNUSED_ATM_AMOUNT_OFFSET, ConcurCollectorBatchFixture.ATM_CASH_ADVANCE_UNUSED_TEST, 6.00),

    ATM_CASH_ADVANCE_FEE_AND_UNUSED_TEST_ENTRY1(DEFAULT_DEBIT, ConcurCollectorBatchFixture.ATM_CASH_ADVANCE_FEE_AND_UNUSED_TEST, 4.00),
    ATM_CASH_ADVANCE_FEE_AND_UNUSED_TEST_ENTRY2(DEFAULT_ATM_FEE_DEBIT, ConcurCollectorBatchFixture.ATM_CASH_ADVANCE_FEE_AND_UNUSED_TEST, 3.50),
    ATM_CASH_ADVANCE_FEE_AND_UNUSED_TEST_CA_ENTRY1(DEFAULT_ATM_CASH_ADVANCE_CREDIT, ConcurCollectorBatchFixture.ATM_CASH_ADVANCE_FEE_AND_UNUSED_TEST, 13.50),
    ATM_CASH_ADVANCE_FEE_AND_UNUSED_TEST_OFFSET1(DEFAULT_UNUSED_ATM_AMOUNT_OFFSET, ConcurCollectorBatchFixture.ATM_CASH_ADVANCE_FEE_AND_UNUSED_TEST, 6.00),

    MULTI_ATM_CASH_ADVANCE_TEST_ENTRY1(DEFAULT_DEBIT, ConcurCollectorBatchFixture.MULTI_ATM_CASH_ADVANCE_TEST, 11.89),
    MULTI_ATM_CASH_ADVANCE_TEST_CA_ENTRY1(DEFAULT_ATM_CASH_ADVANCE_CREDIT, ConcurCollectorBatchFixture.MULTI_ATM_CASH_ADVANCE_TEST, 11.89),

    MULTI_REPORT_ATM_CASH_ADVANCE_TEST_ENTRY1(DEFAULT_DEBIT, ConcurCollectorBatchFixture.MULTI_REPORT_ATM_CASH_ADVANCE_TEST, 4.00),
    MULTI_REPORT_ATM_CASH_ADVANCE_TEST_CA_ENTRY1(DEFAULT_ATM_CASH_ADVANCE_CREDIT, ConcurCollectorBatchFixture.MULTI_REPORT_ATM_CASH_ADVANCE_TEST, 4.00),
    MULTI_REPORT_ATM_CASH_ADVANCE_TEST_ENTRY2(DEFAULT_DEBIT, ConcurCollectorBatchFixture.MULTI_REPORT_ATM_CASH_ADVANCE_TEST, 7.89,
            buildOverride(LineField.DOCUMENT_NUMBER, "CLTEJJJJJKKKKK")),
    MULTI_REPORT_ATM_CASH_ADVANCE_TEST_CA_ENTRY2(DEFAULT_ATM_CASH_ADVANCE_CREDIT, ConcurCollectorBatchFixture.MULTI_REPORT_ATM_CASH_ADVANCE_TEST, 7.89,
            buildOverride(LineField.DOCUMENT_NUMBER, "CLTEJJJJJKKKKK")),

    ATM_CASH_ADVANCE_MULTI_FEE_TEST_ENTRY1(DEFAULT_DEBIT, ConcurCollectorBatchFixture.ATM_CASH_ADVANCE_MULTI_FEE_TEST, 4.00),
    ATM_CASH_ADVANCE_MULTI_FEE_TEST_ENTRY2(DEFAULT_ATM_FEE_DEBIT, ConcurCollectorBatchFixture.ATM_CASH_ADVANCE_MULTI_FEE_TEST, 9.25),
    ATM_CASH_ADVANCE_MULTI_FEE_TEST_CA_ENTRY1(DEFAULT_ATM_CASH_ADVANCE_CREDIT, ConcurCollectorBatchFixture.ATM_CASH_ADVANCE_MULTI_FEE_TEST, 13.25),

    ATM_AND_REQUESTED_CASH_ADVANCE_TEST_ENTRY1(DEFAULT_DEBIT, ConcurCollectorBatchFixture.ATM_AND_REQUESTED_CASH_ADVANCE_TEST, 9.55),
    ATM_AND_REQUESTED_CASH_ADVANCE_TEST_CA_ENTRY1(DEFAULT_CASH_ADVANCE_CREDIT, ConcurCollectorBatchFixture.ATM_AND_REQUESTED_CASH_ADVANCE_TEST, 5.33),
    ATM_AND_REQUESTED_CASH_ADVANCE_TEST_CA_ENTRY2(DEFAULT_ATM_CASH_ADVANCE_CREDIT, ConcurCollectorBatchFixture.ATM_AND_REQUESTED_CASH_ADVANCE_TEST, 11.22),
    ATM_AND_REQUESTED_CASH_ADVANCE_TEST_OFFSET1(DEFAULT_UNUSED_ATM_AMOUNT_OFFSET, ConcurCollectorBatchFixture.ATM_AND_REQUESTED_CASH_ADVANCE_TEST, 7.00);
