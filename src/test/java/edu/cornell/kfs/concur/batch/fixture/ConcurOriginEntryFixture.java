...
public enum ConcurOriginEntryFixture {
    ...
    CASH_AND_CARD_TEST_OFFSET1_A(DEFAULT_PREPAID_OFFSET, ConcurCollectorBatchFixture.CASH_AND_CARD_TEST, 100.00),
    CASH_AND_CARD_TEST_OFFSET1_B(DEFAULT_CASH_OFFSET, ConcurCollectorBatchFixture.CASH_AND_CARD_TEST, 5.00),
