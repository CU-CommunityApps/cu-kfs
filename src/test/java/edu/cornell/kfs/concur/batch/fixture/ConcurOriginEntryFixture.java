...
public enum ConcurOriginEntryFixture {
    ...
    PERSONAL_CHARGE_AND_CREDIT_TEST_ENTRY1(DEFAULT_DEBIT, ConcurCollectorBatchFixture.PERSONAL_CHARGE_AND_CREDIT_TEST, 16.00),
    PERSONAL_CHARGE_AND_CREDIT_TEST_OFFSET1(DEFAULT_PREPAID_OFFSET, ConcurCollectorBatchFixture.PERSONAL_CHARGE_AND_CREDIT_TEST, 16.00),
    PERSONAL_CHARGE_AND_CREDIT_TEST_ENTRY2(DEFAULT_DEBIT, ConcurCollectorBatchFixture.PERSONAL_CHARGE_AND_CREDIT_TEST, 75.00),
    PERSONAL_CHARGE_AND_CREDIT_TEST_OFFSET2(DEFAULT_CASH_OFFSET, ConcurCollectorBatchFixture.PERSONAL_CHARGE_AND_CREDIT_TEST, 75.00);
