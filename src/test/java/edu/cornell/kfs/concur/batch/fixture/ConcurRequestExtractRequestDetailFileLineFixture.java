...
public enum ConcurRequestExtractRequestDetailFileLineFixture {
    ...
    REQUEST_DETAIL_GOOD_LINE_1("04/14/2017", "34YA", new KualiDecimal(10.00), "CORNELL", 1),
    REQUEST_DETAIL_GOOD_LINE_2("04/14/2017", "34YE", new KualiDecimal(40.00), "CORNELL", 2),
    REQUEST_DETAIL_GOOD_LINE_3("04/14/2017", "34YH", new KualiDecimal(200.00), "CORNELL", 1),
    REQUEST_DETAIL_GOOD_LINE_4("04/14/2017", "34YK", new KualiDecimal(3.33), "CORNELL", 3),
    REQUEST_DETAIL_GOOD_LINE_5("04/14/2017", "34YN", new KualiDecimal(5000.00), "CORNELL", 1),
    
    REQUEST_DETAIL_BAD_EMPLOYEE_GROUP_ID_LINE_2("04/14/2017", "34YE", new KualiDecimal(40.00), "HARVARD", 2);
    ...
    private ConcurRequestExtractRequestDetailFileLineFixture(String batchDate, String requestId, KualiDecimal totalApprovedAmount, String employeeGroupId, int numberRequestEntryDetailLines) {
