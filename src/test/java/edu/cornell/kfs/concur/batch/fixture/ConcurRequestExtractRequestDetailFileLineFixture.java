...
public enum ConcurRequestExtractRequestDetailFileLineFixture {
    ...
    private ConcurRequestExtractRequestDetailFileLineFixture(Date batchDate, String requestId, KualiDecimal totalApprovedAmount, String employeeGroupId, int numberRequestEntryDetailLines) {
