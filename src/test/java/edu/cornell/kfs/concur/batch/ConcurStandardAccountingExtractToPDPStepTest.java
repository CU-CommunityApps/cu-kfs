...
public class ConcurStandardAccountingExtractToPDPStepTest {
	...
	public void executeBad1File() throws InterruptedException, IOException {
		TestableConcurStandardAccountingExtractService service = (TestableConcurStandardAccountingExtractService) concurStandardAccountingExtractToPDPStep.getConcurStandardAccountingExtractService();
	...
	public void assertNumberOfFilesAccepted(int numberOfExpectedFiles) {
		...
		assertEquals("The number of files expected in the accept directory is not what we expected", numberOfExpectedFiles, listOfFiles.length);
	}
