...
public enum ConcurCollectorBatchFixture {
    ...
    CASH_EXCEEDS_PERSONAL_TEST(1, 4, 192.88),
    CASH_EQUALS_PERSONAL_TEST(1, 4, 220.76),
    PERSONAL_EXCEEDS_CASH_TEST(1, 5, 209.76),
    PERSONAL_AND_CASH_ADVANCE_TEST(1, 5, 315.00),
    PERSONAL_CHARGE_AND_RETURN_TEST(1, 3, 91.00),
    PERSONAL_CHARGE_AND_PARTIAL_RETURN_TEST(1, 4, 92.00),
