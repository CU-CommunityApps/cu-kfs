...
public enum RassXmlDocumentWrapperFixture {
        ...
        RASS_SINGLE_AGENCY_SUBSEQUENT_UPDATE("2019-03-15T22:15:07.273", awardFixtures(), agencyFixtures(RassXmlAgencyEntryFixture.SOME_V3)),
        ...
        RASS_SINGLE_AGENCY_UPDATE_AFTER_CREATE("2019-03-16T22:15:17.274", awardFixtures(), agencyFixtures(RassXmlAgencyEntryFixture.LIMITED_LTD_UPDATE)),
        ...
        RASS_SINGLE_AWARD_GRANT_NUM_UPDATE_FILE("2019-04-19T23:18:07.278",
                awardFixtures(RassXmlAwardEntryFixture.SOME_DEPARTMENT_PROJECT_GRANT_NUM_CHANGE), agencyFixtures()),
        RASS_SINGLE_AWARD_GRANT_NUM_UPDATE_FILE2("2019-04-19T23:18:07.288",
                awardFixtures(RassXmlAwardEntryFixture.SOME_DEPARTMENT_PROJECT_GRANT_NUM_CHANGE2), agencyFixtures()),
        RASS_AWARD_MULTI_CHANGE_GRANT_NUM_FILE("2019-04-19T23:18:07.298",
        ...
        RASS_AWARD_UPDATE_MISSING_FIELD_FILE("2019-03-18T20:19:56.273",
    ...
    public final LocalDateTime extractLocalDateTime;
    ...
    private RassXmlDocumentWrapperFixture(RassXmlDocumentWrapperFixture fixtureToCopy) {
        this.extractLocalDateTime = fixtureToCopy.extractLocalDateTime;
    ...
    private RassXmlDocumentWrapperFixture(String extractDateTimeString, RassXmlAwardEntryFixture[] awardsArray, RassXmlAgencyEntryFixture[] agencyArray) {
        extractLocalDateTime = RassStringToJavaLocalDateTimeZoneDefaultAdapter.parseToLocalDateTime(extractDateTimeString);
    ...
    public RassXmlDocumentWrapper toRassXmlDocumentWrapper() {
        ...
        wrapper.setExtractDate(extractLocalDateTime);
