...
public enum RassXmlAgencyEntryFixture {
    ...
    SOME_V3("468", "Some", "Some University", "U", "", "Some Other Additional University", "USA", false),
    LIMITED_LTD("555", "Limited", "Limited Ltd.", "C", "468", "Limited Ltd.", "USA", false),
    LIMITED_LTD_UPDATE("555", "Limited", "Limited Ltd. Company", "C", "468", "Limited Ltd.", "USA", false),
