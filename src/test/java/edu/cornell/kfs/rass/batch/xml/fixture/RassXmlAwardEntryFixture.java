...
public enum RassXmlAwardEntryFixture {
    ...
    ZERO_AMOUNT_COST_SHARE_YES_PROPOSAL_EXISTS("151516", "OS", "2345", "Total amount zero cost share Y proposal exists", "2017-12-31", "2019-12-31", 5300000.000, 700000.000, 0.000, StringUtils.EMPTY,
    ...
    ZERO_AMOUNT_COST_SHARE_NO_PROPOSAL_EXISTS("151517", "OS", "2345", "Total amount zero cost share Y proposal exists", "2017-12-31", "2019-12-31", 5300000.000, 700000.000, 0.000, StringUtils.EMPTY,
            StringUtils.EMPTY, StringUtils.EMPTY, false, StringUtils.EMPTY, primaryOrg("3434"), Boolean.FALSE, null, "2017-12-31",
            "2022-12-31", 0.000, "1234S",  true, false, "COST", true, true, piFixtures(RassXMLAwardPiCoPiEntryFixture.mgw3_PRIMARY)),
    ZERO_AMOUNT_COST_SHARE_YES_PROPOSAL_DOES_NOT_EXIST("151518", "OS", "2345", "Total amount zero cost share Y proposal exists", "2017-12-31", "2019-12-31", 5300000.000, 700000.000, 0.000, StringUtils.EMPTY,
            StringUtils.EMPTY, StringUtils.EMPTY, false, StringUtils.EMPTY, primaryOrg("3434"), Boolean.TRUE, null, "2017-12-31",
            "2022-12-31", 0.000, "1234S",  true, false, "COST", false, false, piFixtures(RassXMLAwardPiCoPiEntryFixture.mgw3_PRIMARY)),
    ZERO_AMOUNT_COST_SHARE_NO_PROPOSAL_DOES_NOT_EXIST("151519", "OS", "2345", "Total amount zero cost share Y proposal exists", "2017-12-31", "2019-12-31", 5300000.000, 700000.000, 0.000, StringUtils.EMPTY,
            StringUtils.EMPTY, StringUtils.EMPTY, false, StringUtils.EMPTY, primaryOrg("3434"), Boolean.FALSE, null, "2017-12-31",
            "2022-12-31", 0.000, "1234S",  true, false, "COST", false, false, piFixtures(RassXMLAwardPiCoPiEntryFixture.mgw3_PRIMARY));
