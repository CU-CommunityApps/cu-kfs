...
public enum  ISOtoFIPSCountryConversionFixture {
    ...
    ALL_INACTIVE_TEST("ALL_INACTIVE_TEST", "THROWS", ISOFIPSCountryMapFixture.ALL_INACTIVE.isoCountryCode, ISOFIPSCountryMapFixture.ALL_INACTIVE),
    ...
    FIPS_INACTIVE_ISO_INACTIVE_MAP_ACTIVE_TEST("FIPS_INACTIVE_ISO_INACTIVE_MAP_ACTIVE_TEST", "THROWS", ISOFIPSCountryMapFixture.FIPS_INACTIVE_ISO_INACTIVE_MAP_ACTIVE.isoCountryCode, ISOFIPSCountryMapFixture.FIPS_INACTIVE_ISO_INACTIVE_MAP_ACTIVE),
