...
public class CuJsonTestUtilsTest {

    @Test
    void testBuildEmptyJsonObjectString() throws Exception {
        String expectedJson = "{}";
        String actualJson = CuJsonTestUtils.buildJsonStringFromEntries();
    ...
    void testCannotBuildJsonFromNullArguments() throws Exception {
        ...
        assertThrows(NullPointerException.class, () -> CuJsonTestUtils.buildJsonStringFromEntries(entries),
                "The JSON-building operation should have failed, due to a null varargs input");
        assertThrows(NullPointerException.class, () -> CuJsonTestUtils.buildJsonStringFromEntries(singleEntry),
    ...
    void testAddPropertyToEmptyJson() throws Exception {
        ...
        String actualJson = CuJsonTestUtils.rebuildJsonStringWithNewOrUpdatedProperty(
                "{}", "netid", "zzz999");
        assertJsonStringsMatch(expectedJson, actualJson);
    }
    ...
    void testCannotOverrideJsonPropertyUsingInvalidJsonString(String invalidJson) throws Exception {
        ...
        assertThrows(expectedExceptionType,
                () -> CuJsonTestUtils.rebuildJsonStringWithNewOrUpdatedProperty(invalidJson, "firstname", "John"),
    ...
    void testCannotOverrideJsonPropertyUsingInvalidPropertyName(String invalidPropertyName) throws Exception {
        assertThrows(IllegalArgumentException.class,
                () -> CuJsonTestUtils.rebuildJsonStringWithNewOrUpdatedProperty(
